<x-layouts.app page-name="Library and Bookshop" :show-title-area="false" :full-width="true">
    ...
    <div
                ...
                <div id="filters"
                    ...
                    <form method="GET" action="{{ route('books.index') }}" class="space-y-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                            ...
                            <div class="space-y-2">
                                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Age Group</label>
                                <div class="relative">
                            ...
                            <div class="space-y-2">
                                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Academic Group</label>
                                <div class="relative">
                            ...
                            <div class="space-y-2">
                                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Academic Level</label>
                                <div class="relative">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <select name="academic_subject" id="academic_subject"
                                            class="w-full px-4 py-3 text-sm rounded-xl focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 text-gray-900 dark:text-white bg-gray-50 dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 transition-all duration-300 appearance-none cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800">
                                        <option value="">All Subjects</option>
                                        @foreach($academicSubjects as $subject)
                                            <option value="{{ $subject->id }}" {{ request('academic_subject') == $subject->id ? 'selected' : '' }}>
                                                {{ $subject->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="sm:col-span-2 lg:col-span-3 xl:col-span-1 flex items-end">
                                <div class="w-full flex flex-col sm:flex-row gap-3">
                                    <button type="submit"
                                            class="flex-1 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white px-6 py-3 rounded-xl font-semibold text-sm transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center space-x-2">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <a href="{{ route('books.index') }}"
                                       class="flex-1 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 px-6 py-3 rounded-xl font-semibold text-sm text-center transition-all duration-300 flex items-center justify-center space-x-2 border-2 border-gray-200 dark:border-gray-700">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="max-w-7xl mx-auto py-12 px-4">
            @if(isset($topCategories) && !request()->hasAny(['search', 'category', 'format', 'price', 'age_group', 'academic_group', 'academic_level', 'academic_subject']))
