<section>
    ...
    <div x-show="activeTab === 'account-information'" class="animate-fade-in hidden">
        <div class="space-y-6">
            <!-- Header -->
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Account Information</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Manage your school's payment account details</p>
                </div>
                        ...
                        <dl class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <dd class="text-base font-semibold text-gray-900 dark:text-white">
                                    {{ $school->subaccount->business_name }}
                                </dd>
                            </div>
                            ...
                            <div>
                                ...
                                <dd class="text-base font-semibold text-gray-900 dark:text-white">
                                    {{ $school->subaccount->settlement_bank }}
                                </dd>
                            </div>
                            ...
                            <div>
                                ...
                                <dd class="text-base font-semibold text-gray-900 dark:text-white font-mono">
                                    {{ $school->subaccount->account_number }}
                                </dd>
                            </div>
                            ...
                            <div>
                                ...
                                <dd class="text-base font-semibold text-gray-900 dark:text-white font-mono">
                                    {{ $school->subaccount->bank_code }}
                                </dd>
                            </div>

                            @if($school->subaccount->subaccount_code)
                                <div class="md:col-span-2">
                                    ...
                                    <dd class="text-sm font-mono text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-900 px-3 py-2 rounded-lg inline-block">
                                        {{ $school->subaccount->subaccount_code }}
                                    </dd>
                                </div>
                            @endif
                        </dl>
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-blue-700 dark:text-blue-300">
                                <ul class="list-disc list-inside space-y-1">
                                    <li>This account will be used to receive payments from students and parents</li>
            ...
            @else
                ...
                <div class="text-center py-12 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                    ...
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400 max-w-md mx-auto">
                        Set up your payment account to start receiving payments from students and parents directly into your bank account.
                    </p>
                    <div class="mt-6">
                        <button wire:click="createAccount" type="button"
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" wire:model.defer="accountName"
                                       placeholder="School name or account holder name"
