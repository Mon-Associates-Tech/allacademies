<div class="space-y-6">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <div class="flex items-center space-x-4">
                ...
                <div class="relative">
                    ...
                    @else
                        <div class="w-16 h-16 rounded-full bg-white/20 flex items-center justify-center border-4 border-white/20">
    ...
    @if (session()->has('success'))
        <div class="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg relative dark:bg-green-900 dark:border-green-700 dark:text-green-200" role="alert">
    ...
    @if (session()->has('error'))
        <div class="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg relative dark:bg-red-900 dark:border-red-700 dark:text-red-200" role="alert">
            <div class="flex items-center">
                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-blue-600 dark:text-blue-400">{{ $profileStats['total_assessments'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-green-600 dark:text-green-400">{{ $profileStats['average_score'] }}%</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-purple-600 dark:text-purple-400">{{ $profileStats['this_month_assessments'] }}</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="space-y-3">
                            ...
                            @if($studentGroup->description)
                                <div>
                                    ...
                                    <p class="text-sm text-gray-900 dark:text-gray-100 mt-1">{{ $studentGroup->description }}</p>
                                </div>
                            @endif
                            @if($studentGroup->teacher)
                                <div class="flex items-center justify-between">
                                    <span class="text-sm font-medium text-gray-500 dark:text-gray-400">Teacher:</span>
                                    <span class="text-sm text-gray-900 dark:text-gray-100">{{ $studentGroup->teacher->user->name }}</span>
                                </div>
                            @endif
                        </div>
                    </div>
