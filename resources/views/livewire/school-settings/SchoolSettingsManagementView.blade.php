<div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="flex-1 min-w-0">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-600">Configure and manage your school's system preferences
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="mb-8 animate-in slide-in-from-top-4 duration-500">
            <div
                class="bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-green-400 rounded-r-lg p-4 shadow-sm">
        ...
        <div class="space-y-6">
            ...
            <div
                class="bg-white/70 backdrop-blur-sm shadow-lg rounded-2xl border border-white/20 overflow-hidden hover:shadow-xl transition-all duration-300">
                <!-- Group Header -->
                <div class="bg-gradient-to-r from-gray-50 to-blue-50 px-6 py-4 border-b border-gray-200/50">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            <div
                                class="w-8 h-8 bg-gradient-to-br from-indigo-500 to-blue-600 rounded-lg flex items-center justify-center">
                        ...
                        <div class="flex items-start justify-between">
                            <div class="flex-1 min-w-0 mr-6">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <div class="flex-1">
                                        @include('livewire.school-settings.partials.value-display', ['setting' =>
                                        $setting])
                                    </div>
                                </div>
                            </div>
            ...
            <div class="text-center py-16">
                <div class="max-w-md mx-auto">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">No settings configured yet</h3>
                    <p class="text-gray-600 mb-8">Start customizing your school's system by adding your first setting
                        configuration.</p>
                    <button type="button" wire:click="showCreateModal"
                        class="inline-flex items-center px-6 py-3 border border-transparent text-sm font-medium rounded-xl text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105">
                        <svg class="-ml-1 mr-2 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
