    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="flex-1 min-w-0">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-600">Configure and manage your school's system preferences</p>
                        </div>
                    </div>
                </div>
        ...
        @if (session()->has('success'))
            <div class="mb-8 animate-in slide-in-from-top-4 duration-500">
                <div class="bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-green-400 rounded-r-lg p-4 shadow-sm">
                    <div class="flex items-center">
                        ...
                        <div class="ml-auto">
                            <button type="button" class="text-green-400 hover:text-green-600 transition-colors duration-200">
                            ...
                            <div class="px-6 py-5 hover:bg-gray-50/50 transition-colors duration-200">
                                <div class="flex items-start justify-between">
                                    ...
                                    <div class="flex items-center space-x-1">
                                        <button type="button"
                                                wire:click="showValueEditModal({{ $setting->id }})"
                                        ...
                                        <button type="button"
                                                wire:click="showEditModal({{ $setting->id }})"
            ...
            @empty
                ...
                <div class="text-center py-16">
                    <div class="max-w-md mx-auto">
                        ...
                        <p class="text-gray-600 mb-8">Start customizing your school's system by adding your first setting configuration.</p>
                        <button type="button"
                                wire:click="showCreateModal"
                                class="inline-flex items-center px-6 py-3 border border-transparent text-sm font-medium rounded-xl text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105">
                            <svg class="-ml-1 mr-2 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
