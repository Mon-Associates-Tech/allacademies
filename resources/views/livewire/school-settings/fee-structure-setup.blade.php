<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8">
    <div class="mx-auto">
        ...
        <div class="mb-8 flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Fee Structure Management</h1>
                <p class="mt-2 text-sm text-gray-600">Manage school fee structures for different academic levels and terms</p>
            </div>
            <button
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            <option value="">{{ empty($academic_year_id) ? 'Select year first' : 'Select Term/Period' }}</option>
                                            @foreach($academicPeriods as $period)
                                                <option value="{{ $period->id }}">
                                                    {{ $period->getDisplayName() }}
                                                    @if($period->is_current) (Current) @endif
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            id="payment_method"
                                            class="block w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200">
