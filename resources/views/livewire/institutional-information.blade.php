...
<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-6 gap-3 mt-3">
        ...
        <div class="col-span-4">
            <x-form.input name="institution" wire:model="institution" type="text" label="Name" />
        </div>
        @if ('college' === $type)
        <div class="col-span-2">
            <x-form.input name="college" wire:model="college" type="text" label="College" />
        </div>
        <div class="col-span-2">
            <x-form.input name="school" wire:model="school" type="text" label="School" />
        </div>
        <div class="col-span-2">
            <x-form.input name="department" wire:model="department" type="text" label="Department" />
        </div>
        @endif
        @if ('faculty' === $type)
        <div class="col-span-3">
            <x-form.input name="faculty" wire:model="faculty" type="text" label="Faculty" />
        </div>
        <div class="col-span-3">
            <x-form.input name="department" wire:model="department" type="text" label="Department" />
        </div>
