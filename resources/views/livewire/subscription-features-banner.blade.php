<div>
    @if($showBanner)
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 shadow-2xl"
            ...
            <div class="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div class="absolute -bottom-8 -left-8 w-64 h-64 bg-purple-300/10 rounded-full blur-3xl animate-pulse" style="animation-delay: 1s;"></div>
                <div class="absolute top-1/2 left-1/2 w-32 h-32 bg-pink-300/10 rounded-full blur-2xl animate-pulse" style="animation-delay: 2s;"></div>
            </div>
            ...
            <div class="relative px-6 py-8 sm:px-8 sm:py-10 lg:px-12 lg:py-12">
                ...
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="text-center mb-8 lg:mb-12">
                        <div class="inline-flex items-center justify-center space-x-2 bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 mb-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 mb-8">
                        @foreach($features as $index => $feature)
                            <div class="group relative bg-white/10 backdrop-blur-md rounded-xl p-6 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-xl"
                                 x-data="{ hovered: false }"
                                 @mouseenter="hovered = true; autoplay = false"
                                 @mouseleave="hovered = false; autoplay = true">

                                <!-- Icon -->
                                <div class="inline-flex items-center justify-center w-12 h-12 rounded-lg bg-gradient-to-br {{ $feature['gradient'] }} text-white mb-4 group-hover:scale-110 transition-transform">
                                    {!! $feature['icon'] !!}
                                </div>
                                ...
                                <!-- Hover Effect Border -->
                                <div class="absolute inset-0 rounded-xl border-2 border-white/0 group-hover:border-white/30 transition-colors pointer-events-none"></div>
                            </div>
                        @endforeach
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                        ...
                        @auth
                            @if(auth()->user()->activeTokenSubscription)
                                <a href="{{ route('token-subscriptions.show', auth()->user()->activeTokenSubscription) }}"
