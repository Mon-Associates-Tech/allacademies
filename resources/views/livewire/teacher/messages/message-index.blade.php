<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">View and manage messages you've sent to students</p>
        </div>
        <a href="{{ route('teachers.messages.compose') }}"
           class="btn-primary">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $statusCounts['sent'] }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $statusCounts['scheduled'] }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $statusCounts['failed'] }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                    ...
                    <tr class="hover:bg-gray-50">
                                ...
                                <div>
                                    ...
                                    @if($message->attachments->count() > 0)
                                        <div class="flex items-center mt-1">
                                            ...
                                            <span class="text-xs text-gray-500">{{ $message->attachments->count() }} attachment(s)</span>
                                        </div>
                                    @endif
                                </div>
                            </div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center space-x-2">
                                <a href="{{ route('teachers.messages.show', $message) }}"
                                ...
                                @if($message->status === 'failed')
                                    <button wire:click="resendMessage({{ $message->id }})"
                                            ...
                                            class="text-green-600 hover:text-green-900" title="Resend">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center">
                            <div class="text-gray-500">
                                ...
                                <p class="mt-1 text-sm text-gray-500">Get started by creating your first message.</p>
                                <div class="mt-6">
                                    <a href="{{ route('teachers.messages.compose') }}"
