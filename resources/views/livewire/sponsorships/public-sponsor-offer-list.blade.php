<div
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12 relative">
            ...
            <div class="relative">
                <div class="inline-flex items-center px-4 py-2 bg-indigo-100 dark:bg-indigo-900/30 rounded-full mb-4">
                    <svg class="w-5 h-5 text-indigo-600 dark:text-indigo-400 mr-2" fill="currentColor"
                         viewBox="0 0 20 20">
                        <path
                ...
                <p class="mt-3 max-w-2xl mx-auto text-lg text-gray-600 dark:text-gray-300">
                    Browse available sponsorship opportunities and apply with your verified projects
                </p>
            </div>
        </div>
        ...
        <div wire:loading.delay class="mb-4">
            <div
                class="bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-800 rounded-lg p-4 flex items-center">
                ...
                <div
                    ...
                    <div class="p-6 flex-grow">
                        ...
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex-1">
                                <span
                                    class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-indigo-100 text-indigo-800 dark:bg-indigo-900 dark:text-indigo-200 ring-2 ring-indigo-500/20 mb-2">
                                    {{ $offer->code }}
                                </span>
                            ...
                            @if($offer->accepts_bids)
                                <span
                                    class="ml-2 inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200 ring-2 ring-green-500/20">
                        ...
                        <div
                            class="mb-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl border border-green-200 dark:border-green-800">
                            ...
                            <p class="text-3xl font-bold text-green-600 dark:text-green-400 flex items-baseline">
                                ...
                                <span
                                    class="text-sm ml-2 text-gray-500">.{{ str_pad((int)(($offer->amount_offered - floor($offer->amount_offered)) * 100), 2, '0', STR_PAD_LEFT) }}</span>
                            </p>
                        </div>
                        ...
                        @if($offer->criteria)
                            <div class="mb-4 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                <div class="flex items-start">
                                    <svg class="w-4 h-4 text-indigo-600 dark:text-indigo-400 mt-0.5 mr-2 flex-shrink-0"
                            ...
                            @if($offer->expires_at)
                                <div class="flex items-center text-gray-600 dark:text-gray-400">
                                    ...
                                    @if($offer->expires_at->diffInDays() <= 7)
                                        <span
                                            class="ml-2 px-2 py-0.5 bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-200 rounded text-xs font-medium animate-pulse">
                                            Urgent
                                        </span>
                                    @endif
                                </div>
                    ...
                    <div
                        class="p-4 bg-gradient-to-r from-gray-50 to-indigo-50/30 dark:from-gray-700/50 dark:to-indigo-900/10 border-t border-gray-100 dark:border-gray-700">
                        @auth
                            @if($offer->accepts_bids)
                                <button wire:click="openBidModal({{ $offer->id }})"
                                    ...
                                    <span class="relative z-10 flex items-center justify-center">
                                        <svg class="w-5 h-5 mr-2 group-hover/btn:animate-pulse" fill="none"
                ...
                <div class="col-span-full">
                    <div class="max-w-md mx-auto text-center">
                        <div
                            ...
                            <div
                                class="mx-auto flex items-center justify-center h-20 w-20 rounded-full bg-gradient-to-br from-indigo-100 to-purple-100 dark:from-indigo-900/30 dark:to-purple-900/30 mb-6">
                            ...
                            <p class="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                                ...
                                @else
                                    No active sponsor offers at the moment. Check back soon or consider creating your
                                    own offer!
                                @endif
                            </p>
                            @if($search)
                            ...
                            @else
                                @auth
                                    <a href="{{ route('sponsorships.offers.create') }}"
        ...
        <div
            class="mt-16 relative overflow-hidden bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 rounded-3xl p-12 shadow-2xl">
            ...
            <div class="relative text-center">
                <h2 class="text-3xl md:text-4xl font-extrabold text-white mb-4">
                    Have a Project That Needs Sponsorship?
                </h2>
                <p class="text-indigo-100 text-lg mb-8 max-w-2xl mx-auto leading-relaxed">
                    Create and verify your sponsorship project to apply for these amazing opportunities!
                </p>
                ...
                <div class="p-6">
                    ...
                    <form wire:submit.prevent="submitBid">
                            ...
                            @if(count($userProjects) === 0)
                                <div
                                    ...
                                    <p class="text-sm text-yellow-800 dark:text-yellow-200">
                                        ⚠️ You need to create and get your project verified first before applying for
                                        sponsorship offers.
                                    </p>
                                    <a href="{{ route('benefactors.projects.create') }}"
                                       class="mt-2 inline-flex items-center text-sm font-medium text-yellow-700 dark:text-yellow-300 hover:text-yellow-900">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea wire:model="bidMessage" rows="5"
                                      class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-indigo-500 focus:border-indigo-500"
                                      placeholder="Explain why your project is a perfect match for this sponsorship opportunity..."></textarea>
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Tell the sponsor how this funding
                                will help achieve your project's goals</p>
                        ...
                        <div
                            ...
                            <button type="button" wire:click="closeBidModal"
                            ...
                            <button type="submit"
                                    class="px-6 py-2.5 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg hover:from-indigo-700 hover:to-purple-700 transition font-semibold shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                                    wire:loading.attr="disabled" {{ count($userProjects) === 0 ? 'disabled' : '' }}>
