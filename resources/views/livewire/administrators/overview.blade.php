<div class="p-6 m-0 rounded-lg  min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm dark:shadow-gray-800">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                ...
                <div class="flex gap-4 w-full sm:w-auto">
                    ...
                    <a href="#"
                       class="text-sm text-blue-600 hover:text-blue-800 whitespace-nowrap transition-colors dark:text-blue-400 dark:hover:text-blue-300">View
                        All</a>
                </div>
            </div>
            ...
            @if($recentUsers->isEmpty())
                <div class="text-center py-12">
                    ...
                    <p class="mt-4 text-gray-500 dark:text-gray-400">No recent users found</p>
                </div>
            @else
                        ...
                        @foreach($recentUsers as $user)
                            <tr class="hover:bg-gray-50 transition-colors dark:hover:bg-gray-700">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                       <div class="h-8 w-8 rounded-full flex items-center justify-center font-medium
                                        ...
                                        <div
                                            class="ml-4 font-medium text-gray-900 dark:text-white">{{ $user->name }}</div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <button class="text-blue-600 hover:text-blue-800 transition-colors">Edit</button>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm dark:shadow-gray-800">
            ...
            @else
                <div class="overflow-x-auto">
                    {{-- resources/views/components/approvals-table.blade.php --}}
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        @foreach($pendingApprovals as $bookApproval)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900 dark:text-white">{{ $bookApproval->author }}</div>
                                </td>
