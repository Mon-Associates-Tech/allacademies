<div class="bg-white dark:bg-gray-900 transition-colors duration-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="mb-8">
            <div class="bg-white dark:bg-gray-800 shadow-2xl rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 transition-colors duration-200">

                <!-- Form Header with Gradient Background -->
                <div class="bg-gradient-to-r from-indigo-500 via-purple-600 to-pink-500 px-8 py-6">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-4">
                            <div class="flex-shrink-0">
                                <div class="w-12 h-12 bg-white bg-opacity-20 backdrop-blur-sm rounded-xl flex items-center justify-center ring-2 ring-white ring-opacity-30">
                            ...
                            <div>
                                <h2 class="text-2xl font-bold text-white">
                                    {{ $isEditing ? 'Edit Student Profile' : 'Create New Student' }}
                                </h2>
                                <p class="text-indigo-100 text-sm mt-1">
                                    {{ $isEditing ? 'Update student information and academic assignments' : 'Add a new student to the academic system' }}
                                </p>
                            </div>
                        </div>
                    ...
                    <form wire:submit.prevent="{{ $isEditing ? 'update' : 'create' }}">
                        ...
                        <div class="mb-10">
                            <div class="flex items-center mb-6">
                                <div class="flex items-center justify-center w-10 h-10 bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl mr-4 shadow-lg">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Essential student details and contact information</p>
                                </div>
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                ...
                                <div class="space-y-2">
                                    ...
                                    @error('name')
                                    <div class="flex items-center mt-2 p-2 bg-red-50 dark:bg-red-900 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-6">
                                ...
                                <div class="space-y-2">
                                    <label class="flex items-center text-sm font-semibold text-gray-700 dark:text-gray-300">
                                        ...
                                        Password
                                        @if($isEditing)
                                            <span class="text-gray-500 text-xs ml-2 font-normal">(leave blank to keep current)</span>
                                        @else
                                            <span class="text-red-500 ml-1">*</span>
                                        @endif
                                    </label>
                        ...
                        <div class="border-t border-gray-200 dark:border-gray-600 pt-10">
                            <div class="flex items-center mb-8">
                                <div class="flex items-center justify-center w-10 h-10 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl mr-4 shadow-lg">
                                    <span class="text-lg font-bold text-white">2</span>
                                </div>
                                <div class="flex-1">
                                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Academic Assignment</h3>
                                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Academic groups, levels, and subject assignments</p>
                                </div>
                                <div class="h-px flex-1 bg-gradient-to-r from-purple-200 to-transparent dark:from-purple-800"></div>
                            </div>
                            ...
                            @if(!empty($availableTeachers) && count($availableTeachers) > 0)
                                <div class="mb-8 p-6 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900 dark:to-indigo-900 rounded-2xl border border-blue-200 dark:border-blue-700 shadow-lg">
                                    <div class="flex items-center mb-4">
                                        <div class="flex-shrink-0">
                                            <div class="w-8 h-8 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-xl flex items-center justify-center shadow-md">
                                        ...
                                        <div class="ml-3">
                                            <h4 class="text-lg font-semibold text-gray-900 dark:text-white">Teacher Assignment</h4>
                                            <p class="text-sm text-gray-600 dark:text-gray-400">Select teachers for this student and assign a primary contact</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 max-h-48 overflow-y-auto p-4 border border-blue-200 dark:border-blue-700 rounded-xl bg-white dark:bg-gray-800 shadow-inner">
                                            @foreach($availableTeachers as $teacher)
                                                <label class="flex items-center space-x-3 cursor-pointer hover:bg-blue-50 dark:hover:bg-blue-900 p-3 rounded-lg transition-all duration-200 group">
                                                    ...
                                                    <span class="text-sm text-gray-700 dark:text-gray-300 group-hover:text-blue-700 dark:group-hover:text-blue-300 font-medium">{{ $teacher->user->name }}</span>
                                                </label>
                                            @endforeach
                                        </div>
                                    </div>
                                    ...
                                    @if(!empty($selectedTeachers))
                                        <div class="mt-4 p-4 bg-white dark:bg-gray-800 rounded-xl border border-blue-200 dark:border-blue-700">
                                            ...
                                            <p class="mt-2 text-xs text-blue-600 dark:text-blue-400">The primary teacher will be the main contact for this student.</p>
                                        </div>
                                    @endif
                            ...
                            @if(!empty($levelSubjects) && count($levelSubjects) > 0)
                                <div class="mb-8 p-6 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900 dark:to-emerald-900 rounded-2xl border border-green-200 dark:border-green-700 shadow-lg">
                                    <div class="flex items-center justify-between mb-6">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0">
                                                <div class="w-8 h-8 bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl flex items-center justify-center shadow-md">
                                                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <div class="ml-3">
                                                <h4 class="text-lg font-semibold text-gray-900 dark:text-white">Subject Access</h4>
                                                <p class="text-sm text-gray-600 dark:text-gray-400">
                                                    Students automatically have access to all subjects in their academic level. You can customize access as needed.
                                                </p>
                                            </div>
                                        </div>
                                        <button type="button" wire:click="$toggle('showIndividualSubjects')"
                                            ...
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                @if($showIndividualSubjects)
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L8.464 8.464M9.878 9.878L4.2 4.2m9.646 7.096l3.536 3.536M21 12c0 2.5-1 4.5-2.5 6.5"></path>
                                                @else
                                    ...
                                    <span class="inline-flex items-center justify-center w-6 h-6 bg-green-100 dark:bg-green-800 text-green-600 dark:text-green-300 rounded-full text-xs font-bold mr-2">
                                        {{ count($levelSubjects) }}
                                    </span>
                                            Academic Level Subjects
                                        </h5>
                                        <div class="p-4 bg-green-100 dark:bg-green-800 border border-green-200 dark:border-green-700 rounded-xl">
                                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                                                ...
                                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-200 dark:bg-green-700 text-green-800 dark:text-green-200">
                                                    {{ $subject->name }}
                                                </span>
                                                        @if(in_array($subject->id, $removedSubjects))
                                                            <span class="text-xs text-red-600 dark:text-red-400 font-medium">(Removed)</span>
                                                        @endif
                                                    </div>
                                                @endforeach
                                            </div>
                                    ...
                                    @if($showIndividualSubjects)
                                        ...
                                        <div class="space-y-6 mt-6 pt-6 border-t border-green-200 dark:border-green-700">
                                            <!-- Remove Level Subjects -->
                                            @if(!empty($levelSubjects) && count($levelSubjects) > 0)
                                                <div class="p-4 bg-red-50 dark:bg-red-900 rounded-xl border border-red-200 dark:border-red-700">
                                                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                                                    ...
                                                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 max-h-32 overflow-y-auto p-3 border border-red-200 dark:border-red-700 rounded-lg bg-white dark:bg-gray-800">
                                                        @foreach($levelSubjects as $subject)
                                                            <label class="flex items-center space-x-2 cursor-pointer hover:bg-red-50 dark:hover:bg-red-900 p-2 rounded transition-all duration-200">
                                                    ...
                                                    <div class="flex items-center mt-2 p-2 bg-red-100 dark:bg-red-800 rounded-lg">
                                                        <svg class="w-4 h-4 mr-2 text-red-500" fill="currentColor" viewBox="0 0 20 20">
                                                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                                                        </svg>
                                                        <span class="text-sm text-red-600 dark:text-red-400">{{ $message }}</span>
                                            ...
                                            @if(!empty($availableAdditionalSubjects) && count($availableAdditionalSubjects) > 0)
                                                <div class="p-4 bg-blue-50 dark:bg-blue-900 rounded-xl border border-blue-200 dark:border-blue-700">
                                                    ...
                                                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 max-h-48 overflow-y-auto p-3 border border-blue-200 dark:border-blue-700 rounded-lg bg-white dark:bg-gray-800">
                                                        @foreach($availableAdditionalSubjects as $subject)
                                                            <label class="flex items-center space-x-2 cursor-pointer hover:bg-blue-50 dark:hover:bg-blue-900 p-2 rounded transition-all duration-200">
                                                                <input type="checkbox" wire:model="additionalSubjects" value="{{ $subject->id }}"
                                                                       class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700">
                                                                <div class="flex-1">
                                                                    <span class="text-sm text-gray-700 dark:text-gray-300 font-medium">{{ $subject->name }}</span>
                                                                    <div class="text-xs text-gray-500 dark:text-gray-400">({{ $subject->academicLevel->name ?? 'Other Level' }})</div>
                                                                </div>
                                                            </label>
                                                        @endforeach
                                                    </div>
                        ...
                        <div class="flex items-center justify-between pt-8 border-t border-gray-200 dark:border-gray-600">
                            ...
                            <div class="flex items-center space-x-4">
                                <button type="submit"
                                    ...
                                    {{ $isEditing ? 'Update Student Profile' : 'Create Student Account' }}
                                </button>
                            </div>
                        </div>
                    </form>
