<div class="space-y-2">
  ...
  <div class="overflow-hidden rounded-md border border-gray-300 bg-white">
    <ul role="list" class="divide-y divide-gray-300">
      ...
      <li x-data="{ url: @js(Storage::url($image->path)), description: @js($image->description) }" class="flex">
        ...
        <div class="flex-none w-28 relative">
          <img src="{{ Storage::url($image->path) }}" alt="{{ $image->description }}" class="absolute inset-0 w-full h-full object-cover">
        </div>
      </li>
      @endforeach
    </ul>
