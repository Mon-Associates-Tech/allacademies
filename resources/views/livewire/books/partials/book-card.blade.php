...
<div
    ...
    <div class="relative h-full flex flex-col">
        ...
        <div class="flex-1 p-6 flex flex-col">
            <!-- Title & Author -->
            <div class="mb-4">
                <h3 class="font-bold text-gray-900 dark:text-white text-lg line-clamp-2 mb-2 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors duration-300 leading-tight">
                    {{ $book->title }}
                </h3>
