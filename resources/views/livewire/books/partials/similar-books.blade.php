...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2">
 ...
 <a href="{{ route('books.index', ['search' =>$book->author->name ?? $book->author->user?->name]) }}"
        ...
        <div class="flex overflow-x-auto space-x-4 pb-4 snap-x snap-mandatory scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-gray-100 dark:scrollbar-track-gray-800">
    ...
    @else
        ...
        <div class="text-center py-6">
            <svg class="w-16 h-16 text-gray-300 dark:text-gray-600 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
