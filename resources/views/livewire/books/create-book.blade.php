    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white shadow-xl rounded-2xl overflow-hidden">
            ...
            <form wire:submit.prevent="create" class="p-8">
                ...
                <!-- Continue with the rest of the form (Table of Contents, Media Files, Publishing Settings) -->
                <!-- I'll include the remaining sections as they were in the original template -->
                                            ...
                                            @if($value === 'published')
                                                <div class="mt-3 p-3 bg-green-50 border border-green-200 rounded-lg">
                                                    <div class="flex items-center text-sm text-green-800">
                                                        ...
                                                        Book will be immediately available to all users
                                                    </div>
                                                </div>
                                            @else
