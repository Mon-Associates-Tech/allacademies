<div class="space-y-6 max-w-2xl">
  <form method="post" enctype="multipart/form-data" wire:submit.prevent="upload">
    ...
    <div class="sm:col-span-2 relative overflow-hidden rounded-md border border-gray-300 focus-within:ring bg-white focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500"> 
      ...
      <div wire:ignore>
        <input class="block w-full border-0 focus:border-0 focus:ring-0 p-2 text-lg" placeholder="Enter Tags" data-pharaonic="tagify" data-component-id="{{ $this->id }}" wire:model="tags" data-suggest data-suggest-list="{{json_encode($tags_suggest)}}" data-classname="customSuggestionsList" data-direct>
      </div>
          ...
          <div class="mb-4 md:mb-0">
            <div class="relative max-w-xs overflow-hidden bg-cover bg-no-repeat">
              <img
                ...
                class="max-w-xs"
                alt="Image" />
              <div class="group absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-gray-200 bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-60">
