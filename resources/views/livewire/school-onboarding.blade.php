...
<div x-data="schoolOnboardingForm()" x-init="init()" class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
    {{-- Progress Bar --}}
    ...
    <div class="max-w-4xl mx-auto py-8">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <input type="tel" id="phone" wire:model.defer="phone"
                                                ...
                                                placeholder="+233 XX XXX XXXX" x-on:input="formatPhoneNumber($event)">
                            ...
                            <div class="space-y-8">
                                        ...
                                        <label
                                            ...
                                            <div class="flex items-center w-full">
                                                <div
                                                    ...
                                                    <i
                                                        class="fas fa-check text-white text-xs opacity-0 group-hover:opacity-100 transition-opacity duration-200"></i>
                                                </div>
                                                <div class="flex-1">
                                                    <span
                                ...
                                <div x-show="$wire.selectedAcademicGroups.length > 0" x-transition>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                        ...
                                        <label
                                            ...
                                            <div class="flex items-center w-full">
                                                <div
                                                    class="flex-shrink-0 w-5 h-5 mr-3 border-2 border-gray-300 rounded group-hover:border-green-500 transition-colors duration-200 flex items-center justify-center">
                                                    <i
                                                        class="fas fa-check text-white text-xs opacity-0 group-hover:opacity-100 transition-opacity duration-200"></i>
                                                </div>
                                                <div class="flex-1">
                                ...
                                <div class="border-t pt-8">
                                    ...
                                    <section>
                                        {{-- ✅ Bank Selection --}}
                                        <div>
                                            <label for="bank" class="block text-sm font-medium text-gray-700">Select
                                                Bank</label>
                                            ...
                                            @error('bank_code') <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                            @enderror
                                        ...
                                        <div>
                                            ...
                                            @error('account_number') <p class="mt-1 text-sm text-red-600">{{ $message }}
                                            </p> @enderror
                                        </div>
                                    </section>
                                </div>
                    ...
                    <div x-show="currentStep === 4" x-transition:enter="transition ease-out duration-500"
                        ...
                        <div class="px-8 py-12 text-center">
                            <div class="mb-8">
                                ...
                                @if($createdSchool)
                                <p class="text-sm text-gray-500">School Code: <span class="font-mono font-semibold">{{
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-600">Start adding teachers, librarians, and
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-600">Add books and configure lending
                                                    policies</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-600">Fine-tune classes and academic
                                                    organization</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-600">Customize preferences and system
                                                    configurations</p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                                ...
                                <button type="button" onclick="window.location.href='/admin/school/settings'"
                ...
                <div class="flex justify-between items-center">
                    <div class="text-sm text-gray-500 flex items-center">
                        ...
                        <template x-if="currentStep === 1">
                            <span>All fields marked with <span class="text-red-500 font-medium">*</span> are
                                required</span>
                        </template>
                    ...
                    <div class="flex space-x-3">
                        ...
                        <template x-if="currentStep === 2">
                            <button type="button" @click="nextStep()" :disabled="!canProceedAnReview()"
                        ...
                        <template x-if="currentStep === 3">
                            <button type="button" wire:click="createSchool" :disabled="!confirmed"
                                ...
                                <span wire:loading.remove wire:target="createSchool" class="flex items-center">
        ...
        <div x-show="currentStep === 1" x-transition
            class="mt-8 bg-white rounded-xl shadow-lg p-6 border border-blue-200">
            ...
            <div class="space-y-4">
                <div class="flex items-start p-3 bg-blue-50 rounded-lg">
                    ...
                    <div>
                        <p class="text-sm"><strong class="text-blue-900">School Name:</strong> Use your official school
                            name as it appears on documents</p>
                    </div>
                </div>
                <div class="flex items-start p-3 bg-green-50 rounded-lg">
                    <i class="fas fa-check-circle text-green-600 mt-1 mr-3 flex-shrink-0"></i>
                    <div>
                        <p class="text-sm"><strong class="text-green-900">Email:</strong> Use an official school email
                            address for communications</p>
                    </div>
                </div>
                <div class="flex items-start p-3 bg-purple-50 rounded-lg">
                    ...
                    <div>
                        <p class="text-sm"><strong class="text-purple-900">Flexibility:</strong> Most settings can be
                            modified later from your dashboard</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 8000000)"
    ...
    <script>
        ...
        document.getElementById('bank_code').addEventListener('change', function(e) {
            ...
            @this.set('settlement_bank', selectedText);
        });
    });
