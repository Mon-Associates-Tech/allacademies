<div>
    ...
    <ul class="mt-3">
        ...
        <li class="mb-0.5 last:mb-0" title="Join Public Assignment">
            <a class="block px-3 py-2 rounded-lg transition {{ Route::is('public-assignments.join*') ? 'bg-violet-500 text-white font-bold' : 'text-gray-800 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-700' }}"
               href="{{ route('public-assignments.join') }}">
                <div class="flex items-center">
                    <svg class="shrink-0 fill-current {{ Route::is('public-assignments.join*') ? 'text-white' : 'text-gray-400 dark:text-gray-500' }}" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
