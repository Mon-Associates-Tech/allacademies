<div>
    ...
    <ul class="mt-3">
        ...
        <!-- Student Management -->
        <li class="mb-0.5 last:mb-0 ">
           <a class="block px-3 py-2 rounded-lg transition {{ Route::is('admin.student-management') ? 'bg-violet-500 text-white font-bold' : 'text-gray-800 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-700' }}"
        ...
        <!-- Student Groups -->
        <li class="mb-0.5 last:mb-0 ">
           <a class="block px-3 py-2 rounded-lg transition {{ Route::is('admin.student-groups') ? 'bg-violet-500 text-white font-bold' : 'text-gray-800 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-700' }}"
        ...
        <!-- Teacher Management -->
        <li class="mb-0.5 last:mb-0 ">
           <a class="block px-3 py-2 rounded-lg transition {{ Route::is('admin.teacher-management') ? 'bg-violet-500 text-white font-bold' : 'text-gray-800 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-700' }}"
        ...
        <li class="mb-0.5 last:mb-0 ">
           <a class="block px-3 py-2 rounded-lg transition {{ Route::is('admin.librarian-management') ? 'bg-violet-500 text-white font-bold' : 'text-gray-800 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-700' }}"
        ...
        <!-- Author Management -->
        <li class="mb-0.5 last:mb-0 ">
           <a class="block px-3 py-2 rounded-lg transition {{ Route::is('admin.author-management') ? 'bg-violet-500 text-white font-bold' : 'text-gray-800 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-700' }}"
        ...
        <!-- Book Management -->
        <li class="mb-0.5 last:mb-0 ">
           <a class="block px-3 py-2 rounded-lg transition {{ Route::is('admin.book-management') ? 'bg-violet-500 text-white font-bold' : 'text-gray-800 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-700' }}"
        ...
        <!-- Book Approvals -->
        <li class="mb-0.5 last:mb-0 ">
           <a class="block px-3 py-2 rounded-lg transition {{ Route::is('admin.book-approvals') ? 'bg-violet-500 text-white font-bold' : 'text-gray-800 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-700' }}"
        ...
        <!-- Subject Management -->
        <li class="mb-0.5 last:mb-0 ">
           <a class="block px-3 py-2 rounded-lg transition {{ Route::is('admin.subject-management') ? 'bg-violet-500 text-white font-bold' : 'text-gray-800 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-700' }}"
        ...
        <li class="mb-0.5 last:mb-0 hidden">
           <a class="block px-3 py-2 rounded-lg transition {{ $activeTab === 'reports' ? 'bg-violet-500 text-white font-bold' : 'text-gray-800 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-700' }}"
               href="#"
        ...
        <!-- User Logins -->
        <li class="mb-0.5 last:mb-0">
           <a class="block px-3 py-2 rounded-lg transition {{ Route::is('admin.logins') ? 'bg-violet-500 text-white font-bold' : 'text-gray-800 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-700' }}"
        ...
        <li class="mb-0.5 last:mb-0">
           <a class="block px-3 py-2 rounded-lg transition {{ Route::is('school-settings.index') ? 'bg-violet-500 text-white font-bold' : 'text-gray-800 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-700' }}"
        ...
        <!-- User Logins -->
        <li class="mb-0.5 last:mb-0 hidden">
           <a class="block px-3 py-2 rounded-lg transition {{ $activeTab === 'teacher-delegate' ? 'bg-violet-500 text-white font-bold' : 'text-gray-800 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-700' }}"
               href="#"
