<div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5">
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $stats['active_sessions'] }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5">
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $stats['average_duration_minutes'] }}m</p>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow mb-6 p-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            {{-- Date Filter --}}
            <div>
                <label for="dateFilter" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Period</label>
