        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Modify your draft message</p>
                </div>
        ...
        <form wire:submit.prevent="update" class="p-6">
            ...
            <div class="mb-6">
                ...
                <div class="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    <div class="text-sm font-medium text-blue-900 mb-1">Target Type</div>
                    <div class="text-sm text-blue-800 capitalize">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    <h3 class="font-medium text-gray-900 mb-3">Selected Roles</h3>
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    <h3 class="font-medium text-gray-900 mb-3">Selected Academic Groups</h3>
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    <h3 class="font-medium text-gray-900 mb-3">Selected Academic Levels</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mb-4">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    <h3 class="font-medium text-gray-900 mb-3">Selected Subjects</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mb-4">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    <h3 class="font-medium text-gray-900 mb-3">Selected Individual Users</h3>
                    <div class="mb-3">
                        <input type="text"
                ...
                <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4">
                    ...
                    <label for="attachment-input" class="cursor-pointer">
                        <div class="text-center">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-600">Click to upload additional files or drag and drop</p>
