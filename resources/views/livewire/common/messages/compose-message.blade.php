<div class="max-w-4xl mx-auto">
    <div class="bg-white shadow-lg rounded-lg">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-600 mt-1">Send messages to specific groups or individuals</p>
        </div>
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-3 mb-4">
                    <label class="relative">
                        <input type="radio" wire:model.live="targetType" value="role" class="sr-only peer">
                        <div class="p-3 border-2 border-gray-200 rounded-lg cursor-pointer peer-checked:border-blue-500 peer-checked:bg-blue-50">
                            <div class="text-sm font-medium text-gray-900">By Role</div>
                            <div class="text-xs text-gray-500">Teachers, Students, etc.</div>
                        </div>
                    </label>
                    ...
                    <label class="relative">
                        ...
                        <div class="p-3 border-2 border-gray-200 rounded-lg cursor-pointer peer-checked:border-blue-500 peer-checked:bg-blue-50">
                            <div class="text-sm font-medium text-gray-900">By Subject</div>
                            <div class="text-xs text-gray-500">Math, English, etc.</div>
                        </div>
                    </label>
                    ...
                    <label class="relative">
                        ...
                        <div class="p-3 border-2 border-gray-200 rounded-lg cursor-pointer peer-checked:border-blue-500 peer-checked:bg-blue-50">
                            <div class="text-sm font-medium text-gray-900">Individuals</div>
                            <div class="text-xs text-gray-500">Specific users</div>
                        </div>
                    </label>

                    <label class="relative">
                        <input type="radio" wire:model.live="targetType" value="custom" class="sr-only peer">
                        <div class="p-3 border-2 border-gray-200 rounded-lg cursor-pointer peer-checked:border-blue-500 peer-checked:bg-blue-50">
                            <div class="text-sm font-medium text-gray-900">Custom</div>
                            <div class="text-xs text-gray-500">Multiple criteria</div>
                        </div>
                    </label>
                </div>
                ...
                @if($targetType === 'role')
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h3 class="font-medium text-gray-900 mb-3">Select Roles</h3>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="flex gap-4">
                            <label class="flex items-center">
                                <input type="checkbox" wire:model.live="includeStudents" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                <span class="ml-2 text-sm text-gray-700">Include Students</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" wire:model.live="includeTeachers" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                <span class="ml-2 text-sm text-gray-700">Include Teachers</span>
                            </label>
                        </div>
                    </div>
                @endif
                ...
                @if($targetType === 'individual')
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h3 class="font-medium text-gray-900 mb-3">Select Individual Users</h3>
                        <div class="mb-3">
                            <input type="text"
                ...
                @if($targetType === 'custom')
                    <div class="bg-gray-50 p-4 rounded-lg space-y-4">
                        <h3 class="font-medium text-gray-900">Custom Targeting (Multiple Criteria)</h3>

                        <!-- All previous targeting options combined -->
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <h4 class="text-sm font-medium text-gray-700 mb-2">Academic Groups</h4>
