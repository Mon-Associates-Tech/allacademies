<div class="space-y-6">
    ...
    <div class="rounded-md p-4
        ...
        @elseif($message->status === 'draft') bg-yellow-50 border border-yellow-200
        ...
        <div class="flex items-center">
            ...
            <div class="ml-3">
                <h3 class="text-sm font-medium
                    ...
                    @elseif($message->status === 'draft') text-yellow-800
                ...
                <div class="mt-1 text-sm
                    ...
                    @elseif($message->status === 'draft') text-yellow-700
