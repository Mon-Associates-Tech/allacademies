...
@if (in_array('page', $selectedOptions))
    <div class="bg-slate-200 p-4 mt-4 rounded">
        ...
        <div class="flex items-center">
            ...
            <x-form.input :has-label="false" class="max-w-[56px]" name="pages_count" type="number" wire:model.live="pagesCount" />
        </div>
    </div>
@endif
...
@if (in_array('space', $selectedOptions))
    <div class="bg-slate-200 p-4 mt-4 rounded">
        ...
        <div class="flex items-center">
            ...
            <x-form.input :has-label="false" class="max-w-[56px]" name="spaces_count" type="number" wire:model.live="spacesCount" />
        </div>
    </div>
@endif
