            ...
            @if($viewType === 'grid')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8">
                    @foreach($books as $book)
                        <div class="group bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-lg hover:border-violet-200 dark:hover:border-violet-700 transition-all duration-300 transform hover:-translate-y-1">
                            <!-- Book Cover with Overlay -->
                            <div class="relative aspect-w-3 aspect-h-4 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-t-xl overflow-hidden">
                                @if($book->cover_image)
                                    <img src="{{ asset('storage/' . $book->cover_image) }}"
                                         alt="{{ $book->title }}"
                                         class="w-full h-48 object-cover transition-transform duration-300 group-hover:scale-105">
                                @else
                                    <div class="w-full h-48 flex items-center justify-center bg-gradient-to-br from-violet-50 to-indigo-50 dark:from-violet-900/20 dark:to-indigo-900/20">
                                ...
                                <div class="absolute top-3 right-3">
                                    @if($book->status === 'published')
                                        <span class="inline-flex items-center px-2.5 py-1 text-xs font-semibold bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100 rounded-full shadow-sm">
                            <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            Published
                                    ...
                                    @elseif($book->status === 'draft')
                                        <span class="inline-flex items-center px-2.5 py-1 text-xs font-semibold bg-amber-100 text-amber-800 dark:bg-amber-800 dark:text-amber-100 rounded-full shadow-sm">
                            <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            Draft
                                    ...
                                    @else
                                        <span class="inline-flex items-center px-2.5 py-1 text-xs font-semibold bg-blue-100 text-blue-800 dark:bg-blue-800 dark:text-blue-100 rounded-full shadow-sm">
                            <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            Review
                                ...
                                <div class="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center space-x-2">
                                    <button class="p-2 bg-white dark:bg-gray-800 rounded-full text-gray-700 dark:text-gray-300 hover:bg-violet-50 dark:hover:bg-violet-900 transition-colors duration-200">
                            ...
                            <div class="p-5">
                                ...
                                <div class="grid grid-cols-2 gap-3 mb-4">
                                    <div class="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg p-3 text-center border border-green-100 dark:border-green-800">
                                        <div class="flex items-center justify-center mb-1">
                                            ...
                                            <span class="text-lg font-bold text-green-700 dark:text-green-300">{{ number_format($book->subscriptions_count) }}</span>
                                        </div>
                                        <div class="text-xs text-green-600 dark:text-green-400 font-medium">Subscriptions</div>
                                    </div>
                                    <div class="bg-gradient-to-r from-purple-50 to-violet-50 dark:from-purple-900/20 dark:to-violet-900/20 rounded-lg p-3 text-center border border-purple-100 dark:border-purple-800">
                                        <div class="flex items-center justify-center mb-1">
                                            ...
                                            <span class="text-lg font-bold text-purple-700 dark:text-purple-300">{{ number_format($book->borrowings_count) }}</span>
                                        </div>
                                ...
                                <!-- Revenue Section -->
                                <div class="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 rounded-lg p-3 text-center mb-4 border border-yellow-100 dark:border-yellow-800">
                                    <div class="flex items-center justify-center mb-1">
                                        <svg class="w-4 h-4 text-yellow-600 dark:text-yellow-400 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                        </svg>
                                        <span class="text-lg font-bold text-yellow-700 dark:text-yellow-300">GHS {{ number_format($book->annual_subscription_fee, 2) }}</span>
                                    </div>
                                ...
                                <div class="flex items-center justify-center mb-4 text-sm">
                                    ...
                                    <div class="flex items-center">
                                        @for($i = 1; $i <= 5; $i++)
                                            <svg class="w-4 h-4 {{ $performanceScore >= ($i * 10) ? $performanceClass : 'text-gray-300 dark:text-gray-600' }}" fill="currentColor" viewBox="0 0 20 20">
