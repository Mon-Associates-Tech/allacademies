<div class="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-indigo-900/10 dark:to-purple-900/10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div class="bg-white/20 backdrop-blur-sm rounded-2xl p-6 border border-white/30">
                        <div class="flex items-center space-x-4">
                            <div class="relative">
                                @if($avatar)
                                    <img src="{{ Storage::url($avatar) }}" alt="Avatar" class="w-16 h-16 rounded-full object-cover border-4 border-white/50">
                                @else
                                    <div class="w-16 h-16 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center text-white font-bold text-2xl border-4 border-white/50">
        ...
        @if (session()->has('profile-updated'))
            <div class="mb-6 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 text-green-800 dark:text-green-200 px-4 py-3 rounded-xl">
            ...
            <div class="flex flex-wrap border-b border-gray-200 dark:border-gray-700 overflow-x-auto">
                @php
                    $tabs = [
                        ...
                        'privacy' => ['icon' => 'eye-off', 'label' => 'Privacy'],
                        'publishing' => ['icon' => 'book-open', 'label' => 'Publishing'],
            ...
            <div class="space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="flex items-center space-x-6">
                                    @if($avatar)
                                        <img src="{{ Storage::url($avatar) }}" alt="Avatar" class="w-20 h-20 rounded-full object-cover border-4 border-purple-100">
                                    @else
                                        <div class="w-20 h-20 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center text-white font-bold text-2xl border-4 border-purple-100">
                                            {{ strtoupper(substr($name, 0, 1)) }}
                                        </div>
                                    @endif
                                    ...
                                    <div class="space-y-2">
                                        <div class="flex space-x-3">
                                            <label class="cursor-pointer inline-flex items-center px-4 py-2 border border-purple-300 rounded-lg text-sm font-medium text-purple-700 bg-white hover:bg-purple-50 focus:outline-none focus:ring-2 focus:ring-purple-500">
                                            ...
                                            @if($avatar)
                                                <button type="button" wire:click="removeAvatar" class="inline-flex items-center px-4 py-2 border border-red-300 rounded-lg text-sm font-medium text-red-700 bg-white hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-red-500">
                                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        @if($new_avatar)
                                            <button type="button" wire:click="uploadAvatar" class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-lg text-sm font-medium hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500">
                                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400">JPG, PNG or GIF. Max size 2MB.</p>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Pen Name</label>
                            ...
                            <!-- Writing Experience -->
                            <div class="md:col-span-2">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Writing Experience</label>
                                <textarea wire:model="writing_experience" rows="3"
                                          class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-700 dark:text-white"
                                          placeholder="Describe your writing experience..."></textarea>
                                @error('writing_experience') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                            </div>
                            ...
                            <!-- Awards -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Awards & Recognition</label>
                            ...
                            <!-- Author Statement -->
                            <div class="md:col-span-2">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Author Statement</label>
                                <textarea wire:model="author_statement" rows="4"
                                          class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-700 dark:text-white"
                                          placeholder="Your personal statement as an author..."></textarea>
                                @error('author_statement') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                            </div>
                        </div>

                        <div class="mt-6 flex justify-end">
                            <button type="submit" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                </svg>
                                Update Profile
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-6 flex justify-end">
                            <button wire:click="updateProfile" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                </svg>
                                Update Social Links
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Genres -->
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                        <div class="bg-gradient-to-r from-green-50 to-teal-50 dark:from-green-900/20 dark:to-teal-900/20 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white flex items-center">
                        ...
                        <div class="p-6">
                            <div class="flex flex-wrap gap-2 mb-4">
                                @foreach($genres as $genre)
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800 dark:bg-green-900/50 dark:text-green-300">
                                        {{ $genre }}
                                        <button wire:click="removeGenre('{{ $genre }}')" class="ml-2 text-green-600 hover:text-green-800 dark:text-green-400 dark:hover:text-green-200">
                            ...
                            <div class="space-y-2">
                                <select class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:text-white"
                    ...
                    <!-- Languages -->
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                        <div class="bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white flex items-center">
                        ...
                        <div class="p-6">
                            <div class="flex flex-wrap gap-2 mb-4">
                                @foreach($languages as $language)
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-orange-100 text-orange-800 dark:bg-orange-900/50 dark:text-orange-300">
                                        {{ $language }}
                                        <button wire:click="removeLanguage('{{ $language }}')" class="ml-2 text-orange-600 hover:text-orange-800 dark:text-orange-400 dark:hover:text-orange-200">
                                            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                                            </svg>
                                        </button>
                            ...
                            <div class="space-y-2">
                                <select class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:text-white"
            ...
            <div class="space-y-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                    ...
                    <form wire:submit.prevent="updatePassword" class="p-6">
                        ...
                        <div class="mt-6 flex justify-end">
                            <button type="submit" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                </svg>
                                Update Password
                        ...
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <div class="flex items-center">
                                <button wire:click="{{ $two_factor_enabled ? 'disable2FA' : 'enable2FA' }}"
                                    ...
                                    <span class="inline-block h-4 w-4 transform rounded-full bg-white transition-transform {{ $two_factor_enabled ? 'translate-x-6' : 'translate-x-1' }}"></span>
                                </button>
                            </div>
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="p-6">
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500 dark:text-gray-400">Current session • New York, NY</p>
                                    </div>
                                </div>
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500 dark:text-gray-400">2 hours ago • New York, NY</p>
                                    </div>
                                </div>
                                <button wire:click="revokeSession('session_id')" class="text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 font-medium text-sm">
                                    Revoke
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-600">
                            <button wire:click="revokeAllSessions" class="text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 font-medium text-sm">
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            @foreach($securityLogs as $log)
                                <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                    <div class="flex items-center space-x-4">
                                        <div class="p-2 bg-{{ $log['status'] === 'success' ? 'green' : 'red' }}-100 dark:bg-{{ $log['status'] === 'success' ? 'green' : 'red' }}-900/50 rounded-lg">
                                            <svg class="w-5 h-5 text-{{ $log['status'] === 'success' ? 'green' : 'red' }}-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-500 dark:text-gray-400">{{ $log['ip_address'] }} • {{ $log['device'] }}</p>
                                        </div>
                                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-4">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <p class="text-2xl font-bold text-gray-900 dark:text-white">${{ number_format($accountStats['total_revenue'], 2) }}</p>
                    ...
                    <div class="p-6">
                        <div class="mb-6">
                            ...
                            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                <div class="bg-blue-600 h-2 rounded-full" style="width: {{ ($storageBreakdown['total_used'] / $storageBreakdown['total_limit']) * 100 }}%"></div>
                            </div>
                        </div>
                            ...
                            @foreach($storageBreakdown['breakdown'] as $type => $data)
                                <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                                    <div class="text-center">
                                        <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ $data['size'] }}MB</p>
                                        <p class="text-sm text-gray-600 dark:text-gray-400 capitalize">{{ $type }}</p>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">{{ $data['count'] }} items</p>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                            ...
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="flex items-center">
                                    <button wire:click="{{ $api_access ? 'revokeApiKey' : 'generateApiKey' }}"
                                        ...
                                        <span class="inline-block h-4 w-4 transform rounded-full bg-white transition-transform {{ $api_access ? 'translate-x-6' : 'translate-x-1' }}"></span>
                                    </button>
                                </div>
                            </div>
                            ...
                            @if($api_key)
                                <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                                    <div class="flex items-center justify-between">
                                        <div class="flex-1">
                                            <p class="text-sm font-medium text-gray-900 dark:text-white mb-1">API Key</p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 font-mono">{{ $api_key }}</p>
                                        </div>
                                        <button class="ml-4 p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" onclick="navigator.clipboard.writeText('{{ $api_key }}')">
        ...
        @if($activeTab === 'publishing')
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-6">
                ...
                <p class="text-gray-600 dark:text-gray-400">Publishing preferences will be implemented here.</p>
            </div>
        @endif

        @if($activeTab === 'billing')
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-6">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Billing & Subscription</h3>
                <p class="text-gray-600 dark:text-gray-400">Billing information will be implemented here.</p>
            </div>
        @endif
