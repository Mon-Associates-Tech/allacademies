                        ...
                        <div class="flex items-start justify-between">
                            ...
                            <div class="flex gap-2 ml-4">
                                ...
                                <a href="{{ route('teachers.classroom.show', $session) }}"
                                   class="inline-flex items-center px-3 py-2 text-sm font-medium text-gray-700 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-600">
                                    View
                                </a>
