<div class="max-w-4xl mx-auto p-6">
    <div class="bg-white rounded-lg shadow-md">
        ...
        <form wire:submit.prevent="createAssignment" class="p-6 space-y-6">
            <!-- Basic Information -->
            ...
            <div>
                ...
                <select id="academic_subject_id" wire:model="academic_subject_id"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                            ...
                            <div class="space-y-2 max-h-32 overflow-y-auto border border-gray-300 rounded-md p-2">
                                @foreach($availableSubtopics as $subtopic)
                                    <label class="flex items-center">
                                        <input type="checkbox" wire:model="selectedSubtopics" value="{{ $subtopic['id'] }}"
                                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                ...
                <div class="space-y-4">
                    ...
                    <div class="border rounded-lg p-4">
                        <div class="flex items-center mb-3">
                            <input type="checkbox" id="mcq_enabled" wire:model="questionTypes.multiple_choice_question.enabled"
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        ...
                        <div class="grid grid-cols-2 gap-4 ml-6">
                            <div>
                                ...
                                <input type="number" wire:model="questionTypes.multiple_choice_question.count" min="1" max="50"
                                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm">
                            </div>
                            <div>
                                <label class="block text-sm text-gray-700">Difficulty</label>
                                <select wire:model="questionTypes.multiple_choice_question.difficulty"
                                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm">
                    ...
                    <div class="border rounded-lg p-4">
                        <div class="flex items-center mb-3">
                            <input type="checkbox" id="tf_enabled" wire:model="questionTypes.true_or_false_question.enabled"
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        ...
                        <div class="grid grid-cols-2 gap-4 ml-6">
                            <div>
                                <label class="block text-sm text-gray-700">Number of Questions</label>
                                <input type="number" wire:model="questionTypes.true_or_false_question.count" min="1" max="50"
                                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm">
                            </div>
                            <div>
                                <label class="block text-sm text-gray-700">Difficulty</label>
                                <select wire:model="questionTypes.true_or_false_question.difficulty"
                                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm">
                                    <option value="all">All Difficulties</option>
                                    <option value="easy">Easy</option>
                                    <option value="medium">Medium</option>
                    ...
                    <div class="border rounded-lg p-4">
                        <div class="flex items-center mb-3">
                            <input type="checkbox" id="essay_enabled" wire:model="questionTypes.essay_question.enabled"
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        ...
                        <div class="grid grid-cols-2 gap-4 ml-6">
                            <div>
                                <label class="block text-sm text-gray-700">Number of Questions</label>
                                <input type="number" wire:model="questionTypes.essay_question.count" min="1" max="20"
                                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm">
                            </div>
                            <div>
                                <label class="block text-sm text-gray-700">Difficulty</label>
                                <select wire:model="questionTypes.essay_question.difficulty"
                                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm">
                                    <option value="all">All Difficulties</option>
                                    <option value="easy">Easy</option>
                                    <option value="medium">Medium</option>
                    ...
                    <div>
                        ...
                        <div class="space-y-2 max-h-32 overflow-y-auto border border-gray-300 rounded-md p-2">
                            @foreach($availableAcademicGroups as $group)
                                <label class="flex items-center">
                                    <input type="checkbox" wire:model="selectedAcademicGroups" value="{{ $group['id'] }}"
                                           class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                    ...
                    <div>
                        ...
                        <div class="space-y-2 max-h-32 overflow-y-auto border border-gray-300 rounded-md p-2">
                            @foreach($availableAcademicLevels as $level)
                                <label class="flex items-center">
                                    <input type="checkbox" wire:model="selectedAcademicLevels" value="{{ $level['id'] }}"
                                           class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                    ...
                    <div>
                        ...
                        <div class="space-y-2 max-h-32 overflow-y-auto border border-gray-300 rounded-md p-2">
                            @foreach($availableStudentGroups as $group)
                                <label class="flex items-center">
                                    <input type="checkbox" wire:model="selectedStudentGroups" value="{{ $group['id'] }}"
                                           class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                    <span class="ml-2 text-sm text-gray-900">{{ $group['name'] }}</span>
                                </label>
                            @endforeach
