                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex items-center justify-end gap-2">
                                            ...
                                            @if($submission->status === 'completed' || $submission->needs_manual_grading)
                                                <a href="{{ route('teachers.public-assignments.grade-submission', $submission) }}" class="p-2 text-green-600 hover:bg-green-50 dark:hover:bg-green-900/30 rounded-lg" title="Grade">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex items-center justify-center min-h-screen p-4">
                ...
                <div class="relative bg-white dark:bg-gray-800 rounded-2xl shadow-xl max-w-3xl w-full p-6 max-h-[90vh] overflow-y-auto">
                    ...
                    <div class="flex gap-3 mt-6">
                        ...
                        <a href="{{ route('teachers.public-assignments.grade-submission', $viewingSubmission) }}" class="flex-1 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg text-center">
                            Grade Submission
                        </a>
                    </div>
                </div>
