...
{{--                <x-form.editor-o wire:model="instructions"  class="rich-editor" name="heading[instructions]" label="Instructions" />--}}
                <x-form.rich-editor wire:model="instructions"  class="rich-editor" name="heading[instructions]" label="Instructions" />
            </div>
        </div>
