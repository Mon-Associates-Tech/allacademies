            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-600">Configure the examination title, duration, and instructions</p>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex space-x-1">
                        <button x-on:click="preview = false"
                            ...
                            <svg class="h-4 w-4 mr-1 inline" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <button x-on:click="preview = true"
                            ...
                            <svg class="h-4 w-4 mr-2 inline" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <div class="flex items-center space-x-2">
                        <!-- Template Info -->
                        <div class="hidden sm:flex items-center space-x-2 text-xs text-gray-500 bg-white px-3 py-1.5 rounded-lg border">
                            <svg class="h-3 w-3" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"/>
                            </svg>
                            <span x-text="'Using ' + $wire.template.charAt(0).toUpperCase() + $wire.template.slice(1) + ' template'"></span>
                        </div>
                        ...
                        <button x-on:click="toggleFullscreen()"
                            ...
                            <svg x-show="!isFullscreen" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15M20.25 3.75h-4.5m4.5 0v4.5m0-4.5L15 9m5.25 11.25h-4.5m4.5 0v-4.5m0 4.5L15 15" />
                            </svg>
                            <svg x-show="isFullscreen" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="display: none;">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 9V4.5M9 9H4.5M9 9L3.75 3.75M15 9v-4.5M15 9h4.5M15 9l5.25-5.25M9 15v4.5M9 15H4.5M9 15l-5.25 5.25M15 15v4.5M15 15h4.5m0 0l5.25 5.25" />
                            </svg>
                        </button>
                ...
                <div class="space-y-6" :class="isFullscreen ? 'max-w-4xl mx-auto' : ''">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <div class="lg:col-span-2">
                            ...
                            <textarea wire:model.live="title"
                                      name="heading[title]"
                                      required
                                      rows="1"
                                      style="resize: vertical"
                                      placeholder="Enter the examination title..."
                                      class="w-full rounded-lg border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 resize-none transition-colors duration-200"></textarea>
                            @error('title')
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input wire:model.live="duration"
                                       name="heading[duration]"
                                       type="text"
                                       required
                                       placeholder="e.g., 120"
                                       class="w-full rounded-lg border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 pr-16 transition-colors duration-200">
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="text-sm text-blue-700 mt-1">
                                    <p>The selected template (<span class="font-medium" x-text="$wire.template"></span>) will be used to render the examination heading with your institution's information.</p>
                ...
                <div :class="isFullscreen ? 'max-w-4xl mx-auto' : ''">
                    ...
                    <div class="mt-8 pt-4 border-t border-gray-200">
                        <div class="flex items-center justify-between text-sm text-gray-500">
                            <span>Template: <span class="font-medium" x-text="$wire.template.charAt(0).toUpperCase() + $wire.template.slice(1)"></span></span>
