    ...
    <div class="rounded-md bg-blue-50 p-4 mb-4">
        <div class="flex">
            ...
            <div class="ml-3 flex-1 md:flex md:justify-between">
                <p class="text-sm text-blue-700">Dial <strong>*772*30#</strong> to pay for any subscription. Merchant Code is <em>1326001</em>. Please use the  reference indicated.</p>
