        ...
        <div class="lg:grid lg:min-h-screen lg:grid-cols-12 relative z-10">
            ...
            <aside class="relative hidden h-32 sm:block lg:order-last lg:col-span-5 lg:h-screen lg:sticky lg:top-0 xl:col-span-6">
                ...
                <div class="absolute bottom-8 left-8 right-8 text-white lg:bottom-16 lg:left-16 lg:right-16">
                    ...
                    <p class="text-lg opacity-90 mb-6">Access 500+ courses and learn from expert instructors</p>
            ...
            <!-- Form section -->
            <main
                class="flex items-center justify-center px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:col-span-7 lg:px-16 xl:col-span-6 lg:overflow-y-auto lg:h-screen lg:py-16 dark:bg-gray-800 bg-white lg:bg-transparent lg:dark:bg-transparent">
                <div class="w-full max-w-md my-auto">
                    <!-- Logo and branding -->
                    <div class="mb-8">
                        <a href="{{ route('register') }}" class="inline-flex items-center text-sm text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 mb-4 transition-colors">
                    ...
                    <!-- register form -->
                    <form method="POST" action="{{ route('register.store-guest') }}" class="space-y-5">
                        @csrf
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="first_name" name="first_name" type="text" required
                                    class="block w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-600 rounded-xl shadow-sm placeholder-gray-400 dark:placeholder-gray-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-blue-500 dark:focus:border-blue-400 transition-colors"
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input
                                    ...
                                    type="checkbox"
                                    required
                                    class="h-4 w-4 text-blue-600 dark:text-blue-500 focus:ring-blue-500 border-gray-300 dark:border-gray-600 dark:bg-gray-700 rounded"
                                >
                            </div>
                            <div class="ml-3 text-sm">
                                <label for="terms" class="text-gray-700 dark:text-gray-300">
                                    ...
                                    <a href="{{route('branding.terms')}}"
                                       class="font-medium text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300">Terms of Service</a>
                                    and
                                    <a href="{{route('branding.privacy')}}"
                                       class="font-medium text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300">Privacy Policy</a>
                                </label>
                            </div>
                        </div>
