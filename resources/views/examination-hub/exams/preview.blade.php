<x-layouts.app>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-7"
        ...
        <form method="POST" action="{{ route('examination-hub.create.store') }}">
            @csrf
            <input type="hidden" name="payload_json" value="{{ $payloadJson }}">
            
            @livewire('examination-hub.question-editor', [
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center gap-4 pt-2">
                <a href="{{ route('examination-hub.create', ['draft' => $payloadJson]) }}" 
