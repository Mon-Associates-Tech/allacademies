<x-layouts.exam>
            ...
            <div id="fullscreen-instruction-panel"
                ...
                <div class="w-full max-w-lg overflow-hidden"
                    ...
                    <div class="h-1 w-full"
                         style="background: linear-gradient(90deg, #b45309, #d97706, #fbbf24);"></div>

                    {{-- Dark header --}}
                    <div
                        class="px-8 py-6 bg-slate-800 dark:bg-slate-900 border-b border-slate-700 dark:border-slate-800">
                        <div class="flex items-start justify-between gap-4">
                            <div class="flex-1 min-w-0">
                                <p class="text-xs font-medium tracking-widest uppercase text-amber-400 mb-1"
                                   style="font-family: 'system-ui', sans-serif; letter-spacing: 0.15em;">Online
                                    Examination</p>
                    ...
                    <div class="px-8 py-7 space-y-5 bg-white dark:bg-slate-900"
                        ...
                        {{-- Fullscreen notice --}}
                        <div
                            style="border-left: 3px solid #d97706; padding-left: 1rem; padding-top: 0.75rem; padding-bottom: 0.75rem;">
                            ...
                            <ul class="space-y-1.5 text-sm text-slate-600 dark:text-slate-400">
                                <li class="flex items-start gap-2">
                                    ...
                                    <span>This examination must be taken in <strong
                                            class="text-slate-800 dark:text-slate-200">full screen</strong> mode.</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg class="w-4 h-4 text-amber-500 flex-shrink-0 mt-0.5" fill="none"
                                         stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <span>Exiting full screen will be logged as a <strong
                                            class="text-slate-800 dark:text-slate-200">violation</strong>.</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg class="w-4 h-4 text-amber-500 flex-shrink-0 mt-0.5" fill="none"
                                         stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <li class="flex items-start gap-2">
                                    ...
                                    <span>Complete all questions before the <strong
                                            class="text-slate-800 dark:text-slate-200">time expires</strong>.</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            <div
                                class="px-4 py-3 bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700"
                                style="border-radius: 2px;">
                                <p class="text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1"
                                   style="font-size: 10px; letter-spacing: 0.1em;">Questions</p>
                                <p class="text-xl font-bold text-slate-900 dark:text-white"
                                   style="letter-spacing: -0.03em;">{{ $questions->count() }}</p>
                            </div>
                            <div
                                class="px-4 py-3 {{ $sectionTimeLimit ? 'bg-amber-50 dark:bg-amber-900/20' : 'bg-slate-50 dark:bg-slate-800/60' }} border border-slate-200 dark:border-slate-700"
                                style="border-radius: 2px; {{ $sectionTimeLimit ? 'border-color: rgba(180,83,9,0.2);' : '' }}">
                                <p class="{{ $sectionTimeLimit ? 'text-amber-700 dark:text-amber-500' : 'text-slate-500 dark:text-slate-400' }} uppercase tracking-wider mb-1"
                                   style="font-size: 10px; letter-spacing: 0.1em;">Time Limit</p>
                                <p class="text-xl font-bold {{ $sectionTimeLimit ? 'text-amber-800 dark:text-amber-400' : 'text-slate-900 dark:text-white' }}"
                            ...
                            <div
                                ...
                                style="border-radius: 2px;">
                                <p class="text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1"
                                   style="font-size: 10px; letter-spacing: 0.1em;">Marks</p>
                                <p class="text-xl font-bold text-slate-900 dark:text-white"
                                   style="letter-spacing: -0.03em;">{{ $totalMarks }}</p>
                            </div>
                        </div>
    ...
    `;
                            ...
                            onTimeExtended: function (additionalMinutes) {
                                ...
                                // NOTE: exam-heartbeat.js setupEchoListener already dispatched
                                // exam:sync-time or exam:extend-time before calling this callback.
                                // Do NOT dispatch a timer event here — it would apply the extension twice.
                                // This callback is for UI feedback only.
