<x-layouts.exam>
    <style>
        ...
        .preview-text-slate { color: #475569; }
        .dark .preview-text-slate { color: #94a3b8; }

        .preview-text-emerald { color: #065f46; }
        .dark .preview-text-emerald { color: #34d399; }
        ...
        .dark .info-card-slate { border-left-color: #94a3b8 !important; }

        .info-card-emerald {
            border-left: 3px solid #059669 !important;
            border-radius: 0 2px 2px 0 !important;
        }
        .dark .info-card-emerald { border-left-color: #34d399 !important; }
    </style>
    ...
    <div class="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 py-8">
        <div class="w-full max-w-2xl">
            ...
            <div class="preview-card border overflow-hidden shadow-xl" style="border-radius: 2px;">
                ...
                {{-- Accent bar — matches exam taking screens --}}
                <div class="h-1 w-full" style="background: linear-gradient(90deg, #b45309, #d97706, #fbbf24);"></div>

                {{-- Dark header — matches the section/empty-section header style --}}
                <div class="px-8 pt-8 pb-7 bg-slate-800 dark:bg-slate-900">
                    <div class="flex items-start gap-4">
                        <div class="flex-shrink-0 w-11 h-11 flex items-center justify-center shadow-md"
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-xs font-semibold uppercase tracking-widest text-amber-400 mb-1"
                ...
                <div class="px-8 py-7 space-y-6" style="font-family: 'system-ui', sans-serif;">
                    ...
                    <div>
                        <div class="flex items-center gap-2 mb-3">
                            <svg class="w-3.5 h-3.5 preview-text-amber" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            <div class="preview-input-group info-card-amber p-4 border">
                                <p class="text-xs font-medium preview-text-amber uppercase mb-1"
                    ...
                    <div>
                        <div class="flex items-center gap-2 mb-3">
                            <svg class="w-3.5 h-3.5 preview-text-slate" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            <div class="preview-section border text-center py-5 px-3" style="border-radius: 2px;">
                                <svg class="w-5 h-5 mx-auto mb-2 preview-text-amber" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="preview-section border text-center py-5 px-3" style="border-radius: 2px;">
                                <svg class="w-5 h-5 mx-auto mb-2 preview-text-slate" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="preview-section border text-center py-5 px-3" style="border-radius: 2px;">
                                <svg class="w-5 h-5 mx-auto mb-2 preview-text-emerald" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    {{-- Total Marks --}}
                    @if($exam->total_marks)
                        <div class="preview-input-group info-card-emerald border flex items-center justify-between px-5 py-4">
                            <div>
                                <p class="text-xs font-semibold uppercase preview-text-emerald mb-0.5"
                                   style="letter-spacing: 0.06em;">Total Marks</p>
                                <p class="text-xs preview-text-muted">Maximum achievable score</p>
                            </div>
                            <p class="text-4xl font-bold preview-text-emerald">{{ $exam->total_marks }}</p>
                        </div>
                    @endif
                </div>
                ...
                <div class="px-8 py-6 preview-section border-t space-y-3">
                    <a href="{{ route('examination-hub.take.start', $exam) }}"
                       class="flex items-center justify-center gap-2.5 w-full px-6 py-3.5 text-sm font-semibold text-white transition-all duration-200 shadow-md hover:shadow-lg hover:-translate-y-px"
                       style="border-radius: 2px; background: linear-gradient(135deg, #b45309, #d97706); box-shadow: 0 2px 12px rgba(180,83,9,0.35);"
                       onmouseover="this.style.background='linear-gradient(135deg, #92400e, #b45309)'"
                       onmouseout="this.style.background='linear-gradient(135deg, #b45309, #d97706)'"
