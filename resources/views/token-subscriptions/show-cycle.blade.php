            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="flex items-center gap-4 mb-6">
                    ...
                    <div class="flex-1">
                        ...
                        @endphp
                        <p class="text-sm text-gray-600 dark:text-gray-400 mt-0.5">{{ $subscriptionCycle->pricingTier->name }}
                            Plan • Month {{ $cyclePosition }} of {{ $totalMonths }}</p>
                    </div>
                ...
                <div
                    ...
                    <div
                        class="relative overflow-hidden {{ $subscriptionCycle->status === 'active' ? 'bg-gradient-to-r from-blue-500 to-cyan-600' : 'bg-gradient-to-r from-gray-500 to-gray-600' }} p-8">
                        {{-- Background Pattern --}}
                        ...
                        <div class="relative">
                            <div class="flex items-start justify-between mb-6">
                                ...
                                <span
                                    class="inline-flex items-center px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-sm font-semibold text-white border border-white/30">
                                ...
                                @if($subscriptionCycle->status === 'active' && $usagePercent >= 80)
                                    <div class="bg-yellow-500/20 border border-yellow-400/30 rounded-lg p-4">
                                        <div class="flex items-start">
                                            <svg class="w-5 h-5 text-yellow-400 mr-3 flex-shrink-0 mt-0.5"
                                            ...
                                            <div>
                                                <p class="text-yellow-300 font-semibold">Running Low on Messengers</p>
                                                <p class="text-yellow-200 text-sm mt-1">You're
                                                    using {{ round($usagePercent, 0) }}% of your monthly messengers.
                                                    Consider upgrading your tier.</p>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                    ...
                    <div class="p-8">
                        <div class="grid lg:grid-cols-3 gap-8">
                                ...
                                <div>
                                    ...
                                    <div class="grid sm:grid-cols-2 gap-4">
                                        <div class="p-4 bg-gray-50 dark:bg-gray-700/30 rounded-lg">
                                            <p class="text-sm text-gray-600 dark:text-gray-400">Month in
                                                Subscription</p>
                                            <p class="text-xl font-bold text-gray-900 dark:text-white mt-1">{{ $cyclePosition }}
                                                of {{ $totalMonths }}</p>
                                        </div>
                                        <div class="p-4 bg-gray-50 dark:bg-gray-700/30 rounded-lg">
                                            <p class="text-sm text-gray-600 dark:text-gray-400">Days Remaining</p>
                                            <p class="text-xl font-bold text-gray-900 dark:text-white mt-1">{{ $subscriptionCycle->getRemainingDays() }}
                                                days</p>
                                            @if($subscriptionCycle->isEndingSoon())
                                                <p class="text-xs text-orange-600 dark:text-orange-400 mt-1">Ending
                                                    soon</p>
                                            @endif
                                        </div>
                                        <div class="p-4 bg-gray-50 dark:bg-gray-700/30 rounded-lg">
                                            ...
                                            <p class="text-xl font-bold text-gray-900 dark:text-white mt-1">
                                                GH₵ {{ number_format($subscriptionCycle->current_price, 2) }}</p>
                                        </div>
                                        <div class="p-4 bg-gray-50 dark:bg-gray-700/30 rounded-lg">
                                        ...
                                        <div class="p-4 bg-gray-50 dark:bg-gray-700/30 rounded-lg">
                                            <p class="text-sm text-gray-600 dark:text-gray-400">Start Date
                                                (Anniversary)</p>
                            ...
                            <div class="pt-8 border-t border-gray-200 dark:border-gray-700">
                                ...
                                <div class="grid sm:grid-cols-1 gap-4">
                                    <div
                                        class="p-4 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                                        <p class="text-sm text-gray-600 dark:text-gray-400">Monthly Increment
                                            (Month {{ $cyclePosition }})</p>
                                        <p class="text-2xl font-bold text-blue-600 dark:text-blue-400 mt-1">
                                            GH₵ {{ number_format($subscriptionCycle->pricingTier->getMonthlyPriceIncrement($cyclePosition), 2) }}</p>
                                        @if($subscriptionCycle->cycle_number <= $subscriptionCycle->pricingTier->initial_period_months)
                                            <p class="text-xs text-blue-700 dark:text-blue-300 mt-2">Initial rate
                                                (first {{ $subscriptionCycle->pricingTier->initial_period_months }}
                                                months)</p>
                                        @else
                                            <p class="text-xs text-blue-700 dark:text-blue-300 mt-2">Reduced rate (after
                                                month {{ $subscriptionCycle->pricingTier->initial_period_months }})</p>
                                        @endif
                                    </div>
                                    <div
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-gray-400">Cumulative Total for Full
                                            Subscription</p>
                                        @php
                                        ...
                                        <p class="text-2xl font-bold text-purple-600 dark:text-purple-400 mt-1">
                                            GH₵ {{ number_format($totalCumulativePrice, 2) }}</p>
                                        <p class="text-xs text-purple-700 dark:text-purple-300 mt-2">Total cost for
                                            all {{ $totalMonths }} months</p>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <p class="text-sm text-amber-900 dark:text-amber-100">
                                        <span class="font-semibold">📋 Pricing Structure:</span>
                                        <br>
                                    <div>
                                        <span>
                                             Month
                                        1-{{ $subscriptionCycle->pricingTier->initial_period_months }}:
                                        <strong>GH₵{{ number_format($subscriptionCycle->pricingTier->initial_price, 2) }}
                                            /month</strong>
                                        </span>
                                        <span>
                                          Month {{ $subscriptionCycle->pricingTier->initial_period_months + 1 }}+:
                                    <strong>GH₵{{ number_format($subscriptionCycle->pricingTier->subsequent_price, 2) }}
                                        /month</strong>
                                        </span>
                                    </div>
                        ...
                        <div class="space-y-6 mt-6">
                            {{-- Circular Progress --}}
                            <div
                                class="bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-700/30 dark:to-blue-900/10 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                                ...
                                <div class="flex justify-center mb-6">
                                    <div class="relative w-32 h-32">
                                        <svg class="w-32 h-32 transform -rotate-90" viewBox="0 0 120 120">
                                            ...
                                            <circle cx="60" cy="60" r="54" fill="none" stroke="currentColor"
                                                    stroke-width="8" stroke-dasharray="339.29"
                                                    :stroke-dashoffset="`{{ 339.29 * (1 - ($usagePercent / 100)) }}`"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex justify-between text-sm">
                                        ...
                                        <span
                                            class="font-semibold text-green-600 dark:text-green-400">{{ number_format($subscriptionCycle->topup_tokens_allocated) }}</span>
                                    </div>
                                    <div
                                        ...
                                        <span
                                            class="font-semibold text-gray-900 dark:text-white">{{ number_format($subscriptionCycle->tokens_allocated) }}</span>
                                    </div>
                                    <div class="flex justify-between text-sm">
                                        <span class="text-gray-600 dark:text-gray-400">Used</span>
                                        <span
                                            class="font-semibold text-gray-900 dark:text-white">{{ number_format($subscriptionCycle->tokens_used) }}</span>
                                    </div>
                                    <div class="flex justify-between text-sm">
                                        <span class="text-gray-600 dark:text-gray-400">Remaining</span>
                                        <span
                                            class="font-semibold text-green-600 dark:text-green-400">{{ number_format($subscriptionCycle->getTokensRemainingAttribute()) }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            {{-- Quick Actions --}}
                            <div
                                class="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/10 dark:to-purple-900/10 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Cycle & Topup
                                    Information</h3>
                                <div class="space-y-3 mb-4">
                                    <div class="p-3 bg-white dark:bg-gray-800 rounded-lg">
                                        <p class="text-xs text-gray-600 dark:text-gray-400 uppercase tracking-wide mb-1">
                                            Anniversary Cycle</p>
                                        <p class="text-sm font-semibold text-gray-900 dark:text-white">Resets on
                                            {{ $subscriptionCycle->cycle_end_date->format('M d') }}</p>
                                    </div>
                                    <div class="p-3 bg-white dark:bg-gray-800 rounded-lg">
                                        <p class="text-xs text-gray-600 dark:text-gray-400 uppercase tracking-wide mb-1">
                                            Base Allocation Remaining</p>
                                        <p class="text-sm font-semibold text-gray-900 dark:text-white">{{ number_format($subscriptionCycle->getBaseTokensRemaining()) }}
                                            tokens</p>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Resets each cycle</p>
                                    </div>
                                    <div class="p-3 bg-white dark:bg-gray-800 rounded-lg">
                                        <p class="text-xs text-gray-600 dark:text-gray-400 uppercase tracking-wide mb-1">
                                            Topup Tokens Remaining</p>
                                        <p class="text-sm font-semibold text-green-600 dark:text-green-400">{{ number_format($subscriptionCycle->getTopupTokensRemaining()) }}
                                            tokens</p>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Carries over
                                            automatically</p>
                                    </div>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Unused topups carry over
                                        automatically</p>
                                </div>
                            </div>
                            <div class="space-y-3">
