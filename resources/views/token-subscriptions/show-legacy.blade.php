            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="flex items-center gap-4 mb-6">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400 mt-0.5">Reference: {{ $subscription->reference }}</p>
                    </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-3">
                                    <div class="flex justify-between items-start">
                                        ...
                                        <span class="font-semibold text-gray-900 dark:text-white">{{ $subscription->purchased_at?->format('M d, Y') ?? 'N/A' }}</span>
                                    </div>
                                    <div class="flex justify-between items-start">
                                        <span class="text-gray-600 dark:text-gray-400">Activation Date</span>
                                        <span class="font-semibold text-gray-900 dark:text-white">{{ $subscription->activated_at?->format('M d, Y') ?? 'Not activated' }}</span>
                                    </div>
                                    <div class="flex justify-between items-start">
                                    ...
                                    <div class="flex justify-between items-start">
                                        ...
                                        <code class="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded text-xs text-gray-900 dark:text-white">{{ $subscription->reference }}</code>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-3">
                                    <div class="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                        ...
                                        <span class="font-bold text-xl text-gray-900 dark:text-white">{{ number_format($subscription->tokens_purchased) }}</span>
                                    </div>
                                    <div class="flex justify-between items-center p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
                                        ...
                                        <span class="font-bold text-xl text-red-600 dark:text-red-400">{{ number_format($subscription->tokens_used) }}</span>
                                    </div>
                                    <div class="flex justify-between items-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                                        <span class="text-green-600 dark:text-green-400">Remaining</span>
                                        <span class="font-bold text-xl text-green-600 dark:text-green-400">{{ number_format($subscription->tokens_remaining) }}</span>
                                    </div>
                                    <div class="text-sm text-gray-600 dark:text-gray-400 pt-2 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div class="border-t border-gray-200 dark:border-gray-700 pt-8">
                            ...
                            <div class="grid sm:grid-cols-2 gap-4">
                                <a href="{{ route('token-subscriptions.create') }}"
                                   class="inline-flex items-center justify-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors shadow-lg">
