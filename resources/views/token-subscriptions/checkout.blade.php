                ...
                <div class="flex justify-center mb-12">
                    <div class="flex items-center gap-2 sm:gap-4">
                        <div class="flex flex-col items-center">
                            <div class="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold text-sm shadow-lg">1</div>
                            <span class="text-xs sm:text-sm mt-2 text-gray-600 dark:text-gray-400 whitespace-nowrap font-medium">Choose</span>
                        </div>
                        <div class="w-8 sm:w-12 h-1 bg-gradient-to-r from-blue-300 to-indigo-300 dark:from-blue-700 dark:to-indigo-700 rounded-full"></div>
                        <div class="flex flex-col items-center">
                            <div class="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold text-sm shadow-lg">2</div>
                            <span class="text-xs sm:text-sm mt-2 text-gray-600 dark:text-gray-400 whitespace-nowrap font-medium">Review</span>
                        </div>
                        <div class="w-8 sm:w-12 h-1 bg-gray-300 dark:bg-gray-600 rounded-full"></div>
                        <div class="flex flex-col items-center">
                            <div class="flex items-center justify-center w-10 h-10 rounded-full bg-gray-300 dark:bg-gray-600 text-gray-700 dark:text-gray-300 font-bold text-sm shadow-md">3</div>
                    ...
                    <div class="grid lg:grid-cols-3 gap-8 p-8">
                        ...
                        <div class="lg:col-span-2 space-y-8">
                            ...
                            <div>
                                ...
                                <div class="space-y-4">
                                    {{-- Plan Name --}}
                                    <div class="flex justify-between items-center p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                                        <span class="text-gray-600 dark:text-gray-400 font-medium">Selected Plan</span>
                                        <span class="text-2xl font-bold text-blue-600 dark:text-blue-400">{{ $pricingTier->name }}</span>
                                    </div>

                                    {{-- Duration --}}
                                    <div class="flex justify-between items-center p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg border border-green-200 dark:border-green-800">
                                        <span class="text-gray-600 dark:text-gray-400 font-medium">Subscription Duration</span>
                                        <span class="text-2xl font-bold text-green-600 dark:text-green-400">{{ $months }} Month{{ $months > 1 ? 's' : '' }}</span>
                                    </div>

                                    {{-- Monthly Tokens --}}
                                    <div class="flex justify-between items-center p-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
                                        <span class="text-gray-600 dark:text-gray-400 font-medium">Tokens Per Month</span>
                                        <span class="text-2xl font-bold text-purple-600 dark:text-purple-400">{{ number_format($pricingTier->monthly_token_limit) }}</span>
                                    </div>

                                    {{-- Total Tokens --}}
                                    <div class="flex justify-between items-center p-4 bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 rounded-lg border border-orange-200 dark:border-orange-800">
                                        <span class="text-gray-600 dark:text-gray-400 font-medium">Total Tokens (All Months)</span>
                                        <span class="text-2xl font-bold text-orange-600 dark:text-orange-400">{{ number_format($pricingTier->monthly_token_limit * $months) }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <ul class="space-y-3">
                                    ...
                                    <li class="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700/30 rounded-lg">
                                        ...
                                        <span class="text-gray-700 dark:text-gray-300">Cancel anytime, no hidden fees</span>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="lg:col-span-1">
                            <div class="bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-700/30 dark:to-blue-900/10 rounded-xl p-6 border border-gray-200 dark:border-gray-700 sticky top-20">
                                ...
                                <div class="flex justify-between items-center mb-6 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-lg p-4">
                                    ...
                                    <span class="text-2xl font-bold text-white">GH₵ {{ number_format($totalPrice, 2) }}</span>
                                </div>

                                {{-- Payment Method --}}
                                <div class="mb-6">
                                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-3 font-medium">Payment Method</p>
                                    <div class="flex items-center gap-3 p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-500 dark:text-gray-400">Secure payment processing</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 mb-6">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p class="text-sm font-semibold text-green-900 dark:text-green-100">Secure & Encrypted</p>
                                            <p class="text-xs text-green-700 dark:text-green-200 mt-1">Your payment information is protected with industry-standard encryption</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-3">
                                    <form action="{{ route('token-subscriptions.process-payment') }}" method="POST">
                                        ...
                                        <button type="submit" class="w-full py-3 px-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center gap-2">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h10m4 0a1 1 0 11-2 0m2 0a1 1 0 10-2 0m-4-5a4 4 0 11-8 0 4 4 0 018 0z"/>
                                            </svg>
                                            Proceed to Payment
                                        </button>
                                    </form>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-6 text-center">
                                    By clicking "Proceed to Payment", you agree to our <a href="{{ route('branding.terms') }}" class="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">Terms of Service</a>
                                </p>
                            </div>
                        </div>
                    </div>
