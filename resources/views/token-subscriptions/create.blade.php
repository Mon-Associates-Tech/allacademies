    ...
    <section class="py-12 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 min-h-screen">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-6xl mx-auto"
                 x-data="{ selectedPlan: null, showComparison: false, estimatedCost: 0, showNotification: false, notificationMessage: '', notificationType: 'success' }">
                ...
                <div class="mb-12 text-center animate-fadeInDown">
                    ...
                    <div x-show="showNotification" x-transition:enter="transition ease-out duration-300"
                         x-transition:leave="transition ease-in duration-200" class="fixed top-4 right-4 z-50 max-w-sm">
                        <div :class="{
                            ...
                            <div class="flex-shrink-0 mt-0.5">
                                <svg x-show="notificationType === 'success'" class="w-6 h-6" fill="currentColor"
                                     viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                          d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                          clip-rule="evenodd"/>
                                </svg>
                                <svg x-show="notificationType === 'error'" class="w-6 h-6" fill="currentColor"
                                     viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                          d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z"
                                          clip-rule="evenodd"/>
                                </svg>
                                <svg x-show="notificationType === 'info'" class="w-6 h-6" fill="currentColor"
                                     viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                    ...
                    <div class="mb-6">
                        <div
                            class="mb-4 inline-block px-4 py-2 bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30 rounded-full border border-blue-200 dark:border-blue-800">
                    ...
                    {{-- Progress Steps --}}
                    <div class="hidden justify-center mt-8">
                        <div class="flex items-center gap-2 sm:gap-4">
                            <div class="flex flex-col items-center animate-fadeInUp" style="animation-delay: 0.1s;">
                                <div
                                    class="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold text-sm shadow-lg transform transition-transform duration-300 hover:scale-110">
                                    1
                                </div>
                                <span
                            ...
                            <div
                                class="w-8 sm:w-12 h-1 bg-gradient-to-r from-blue-300 to-indigo-300 dark:from-blue-700 dark:to-indigo-700 rounded-full animate-slideIn"
                                style="animation-delay: 0.2s;"></div>
                            <div class="flex flex-col items-center animate-fadeInUp" style="animation-delay: 0.3s;">
                                <div
                                    class="flex items-center justify-center w-10 h-10 rounded-full bg-gray-300 dark:bg-gray-600 text-gray-700 dark:text-gray-300 font-bold text-sm shadow-md transform transition-transform duration-300 hover:scale-110">
                                    2
                                </div>
                                <span
                            ...
                            <div class="flex flex-col items-center animate-fadeInUp" style="animation-delay: 0.4s;">
                                ...
                                <span
                                    class="text-xs sm:text-sm mt-2 text-gray-500 dark:text-gray-400 whitespace-nowrap font-medium">Activate</span>
                            </div>
                        </div>
                    </div>
                ...
                <div id="packageContainer">
                    ...
                    @if($currentSubscription)
                        <div
                            class="mb-8 bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-900/20 dark:to-blue-900/20 rounded-2xl p-6 border border-indigo-200 dark:border-indigo-800 shadow-lg hover:shadow-xl transition-all duration-300 animate-slideIn">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3">
                                        ...
                                        <span
                                            class="text-indigo-600 dark:text-indigo-400 bg-indigo-100/50 dark:bg-indigo-900/30 px-3 py-1 rounded-full text-sm">
                                            {{ $currentSubscription->package?->name ?? $currentSubscription->pricingTier?->name ?? 'Active Subscription' }}
                                        </span>
                                    </h3>
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <div
                                            class="bg-white dark:bg-gray-800/50 rounded-lg p-3 transform transition-transform duration-300 hover:scale-105">
                                            <p class="text-xs text-gray-600 dark:text-gray-400 uppercase tracking-wide font-semibold">
                                                Remaining Messengers</p>
                                        ...
                                        <div
                                            ...
                                            <div class="mt-1">
                                                <p class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200 shadow-sm">
                                                    <span
                                                        class="inline-block w-2 h-2 mr-2 rounded-full bg-green-600 dark:bg-green-400 animate-pulse"></span>
                                                    Active
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div
                                        class="mt-4 p-4 bg-indigo-100/50 dark:bg-indigo-900/30 rounded-lg border-l-4 border-indigo-600 dark:border-indigo-400">
                                        <p class="text-sm text-indigo-900 dark:text-indigo-100">
                                            <strong>💡 Pro Tip:</strong> Purchasing a new package will add messengers to
                                            your account. Your existing messengers will be preserved.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="mb-12" x-data="{ selectedTier: null, selectedMonths: 1 }">
                            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Step 1: Choose Your
                                Tier</h2>
                            <div class="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-12">
                                        ...
                                        <button
                                            ...
                                            @if($isPremium)
                                                <div class="absolute -top-3 left-1/2 transform -translate-x-1/2 z-50">
                                                    <span
                                                        class="inline-flex items-center gap-1 px-3 py-1 bg-gradient-to-r from-purple-500 to-pink-600 text-white text-xs font-bold rounded-full shadow-lg animate-pulse">
                                            ...
                                            {{-- Header Badge --}}
                                            <div
                                                class="bg-gradient-to-r rounded-t-2xl {{ $isPremium ? 'from-purple-500 to-pink-600' : 'from-blue-500 to-cyan-600' }} text-white text-center py-3 px-4 text-xs font-bold uppercase tracking-widest relative overflow-hidden">
                                                <div class="absolute inset-0 bg-white/10 animate-pulse"></div>
                                                <span
                                                    class="relative">{{ $isPremium ? '👑 Premium Plan' : '⭐ Basic Plan' }}</span>
                                            </div>
                                            ...
                                            <div class="p-6 flex flex-col flex-1 relative">
                                                ...
                                                <div class="absolute top-4 right-4">
                                                    <div
                                                        :class="{ 'opacity-100': selectedTier === {{ $tier->id }}, 'opacity-0': selectedTier !== {{ $tier->id }} }"
                                                        class="transition-opacity duration-300">
                                                        <svg
                                                            class="w-6 h-6 {{ $isPremium ? 'text-purple-600' : 'text-blue-600' }}"
                                                ...
                                                <div class="mb-6 space-y-3">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="flex justify-between items-start mb-2">
                                                            ...
                                                            <span
                                                                class="inline-block px-2 py-1 bg-{{ $isPremium ? 'purple' : 'blue' }}-200 dark:bg-{{ $isPremium ? 'purple' : 'blue' }}-800 rounded text-xs font-semibold text-{{ $isPremium ? 'purple' : 'blue' }}-700 dark:text-{{ $isPremium ? 'purple' : 'blue' }}-200">Intro</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="flex justify-between items-start mb-2">
                                                            ...
                                                            <span
                                                                class="inline-block px-2 py-1 bg-green-200 dark:bg-green-800 rounded text-xs font-semibold text-green-700 dark:text-green-200">Reduced</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <ul class="space-y-3 mb-6 flex-1">
                                                    ...
                                                    <li class="flex items-start gap-3 text-sm transform transition-transform duration-200 hover:translate-x-1">
                                                        ...
                                                        <span
                                                            class="text-gray-700 dark:text-gray-300">Cancel anytime</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </button>
                                ...
                                @else
                                    <div class="col-span-full text-center py-12">
                                        <p class="text-gray-600 dark:text-gray-400 text-lg">Pricing tiers are not
                                            available at the moment. Please try again later.</p>
                                    </div>
                                @endif
                            </div>
                            ...
                            <div x-show="selectedTier" x-transition class="mb-12 max-w-4xl mx-auto">
                                ...
                                <div
                                    ...
                                    <p class="text-gray-600 dark:text-gray-400 mb-6">How many months would you like to
                                        subscribe for?</p>
                                    ...
                                    <div class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-3 mb-8">
                                        @for ($m = 1; $m <= 12; $m++)
                                            <button
                                                ...
                                                {{ $m }} {{\Illuminate\Support\Str::plural('month', $m)}}
                                            </button>
                                        @endfor
                                    </div>
                                    ...
                                    <template x-if="selectedTier">
                                        <div
                                            ...
                                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Price
                                                Breakdown</h3>
                                            <div class="space-y-3">
                                                <div
                                                    class="flex justify-between items-center pb-3 border-b border-blue-200 dark:border-blue-700">
                                                    <span
                                                        class="text-gray-600 dark:text-gray-400">Selected Duration</span>
                                    ...
                                    <div class="mt-8">
                                        <form action="{{ route('token-subscriptions.checkout') }}" method="POST"
                                              x-show="selectedTier">
                                            @csrf
                        ...
                        @error('package_id')
                        <div
                            class="mt-6 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800 max-w-2xl mx-auto animate-shake">
                    ...
                    <section>
                        ...
                        <div x-show="showComparison" x-transition:enter="transition ease-out duration-300"
                             x-transition:leave="transition ease-in duration-300" class="mb-12 max-w-5xl mx-auto">
                            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-x-auto">
                                <table class="w-full">
                                    ...
                                    <tr class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-700 dark:to-gray-600 border-b border-gray-200 dark:border-gray-700">
                                        <th class="px-6 py-4 text-left text-sm font-bold text-gray-900 dark:text-white">
                                            Feature
                                        </th>
                                        @foreach($pricingTiers as $tier)
                                    ...
                                    <tr class="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                        <td class="px-6 py-4 text-sm font-semibold text-gray-900 dark:text-white">
                                            Initial Price (6 months)
                                        </td>
                                        @foreach($pricingTiers as $tier)
                                            <td class="px-6 py-4 text-center text-sm">
                                                <span
                                                    class="text-2xl font-bold {{ $tier->name === 'Premium' ? 'text-purple-600 dark:text-purple-400' : 'text-blue-600 dark:text-blue-400' }}">GH₵ {{ number_format($tier->initial_price, 2) }}</span>
                                            </td>
                                        @endforeach
                                    </tr>
                                    <tr class="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                        <td class="px-6 py-4 text-sm font-semibold text-gray-900 dark:text-white">
                                            Reduced Price (after 6 months)
                                        </td>
                                        @foreach($pricingTiers as $tier)
                                            <td class="px-6 py-4 text-center text-sm">
                                                <span
                                                    class="text-2xl font-bold text-green-600 dark:text-green-400">GH₵ {{ number_format($tier->subsequent_price, 2) }}</span>
                                            </td>
                                        @endforeach
                                    </tr>
                                    <tr class="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors bg-blue-50/50 dark:bg-blue-900/10">
                                        ...
                                        @foreach($pricingTiers as $tier)
                                            <td class="px-6 py-4 text-center text-sm">
                                                <span
                                                    class="text-2xl font-bold {{ $tier->name === 'Premium' ? 'text-purple-600 dark:text-purple-400' : 'text-blue-600 dark:text-blue-400' }}">{{ number_format($tier->monthly_token_limit) }}</span>
                                            </td>
                                        @endforeach
                                    </tr>
                                    <tr class="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                    ...
                                    <tr class="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                        <td class="px-6 py-4 text-sm font-semibold text-gray-900 dark:text-white">Auto
                                            Reset
                                        </td>
                                        @foreach($pricingTiers as $tier)
                                            <td class="px-6 py-4 text-center">
                                                <svg class="w-6 h-6 text-green-500 mx-auto" fill="currentColor"
                                                     viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd"
                                                          d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                                          clip-rule="evenodd"/>
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                        <td class="px-6 py-4 text-sm font-semibold text-gray-900 dark:text-white">Cancel
                                            Anytime
                                        </td>
                                        @foreach($pricingTiers as $tier)
                                            <td class="px-6 py-4 text-center">
                        ...
                        <div class="mb-12 mx-auto">
                            <div
                                class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl p-8 border border-blue-200 dark:border-blue-800">
                                ...
                                <div class="grid md:grid-cols-3 gap-6">
                                    <div class="bg-white dark:bg-gray-800 rounded-lg p-4">
                                        <div class="flex items-center mb-3">
                                            <div
                                                class="flex-shrink-0 flex items-center justify-center h-8 w-8 rounded-lg bg-blue-600 text-white font-bold">
                                                1
                                            </div>
                                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white ml-3">30-Day
                                                Cycle</h3>
                                        </div>
                                        <p class="text-sm text-gray-600 dark:text-gray-400">Your subscription resets
                                            every
                                            30 days from the date you signed up (anniversary date), not on calendar
                                            months.</p>
                                    </div>
                                    <div class="bg-white dark:bg-gray-800 rounded-lg p-4">
                                        <div class="flex items-center mb-3">
                                    ...
                                    <div class="bg-white dark:bg-gray-800 rounded-lg p-4">
                                        <div class="flex items-center mb-3">
                                            <div
                                                class="flex-shrink-0 flex items-center justify-center h-8 w-8 rounded-lg bg-green-600 text-white font-bold">
                                                3
                                            </div>
                                ...
                                <div
                                    class="mt-6 p-4 bg-blue-100 dark:bg-blue-900/30 rounded-lg border border-blue-300 dark:border-blue-700">
                                    <p class="text-sm text-blue-900 dark:text-blue-100">
                                        <span class="font-semibold">Example:</span> If you sign up on January 15th, your
                                        cycle resets every 15th of the month (not the 1st).
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3 mb-6">
                            <div
                                class="w-12 h-12 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-lg flex items-center justify-center shadow-lg">
                        ...
                        <p class="text-gray-700 dark:text-gray-300 mb-8 max-w-3xl text-base leading-relaxed">
                            Messengers are tokens consumed when using Messenger features. The amount depends on the
                            complexity and length of your requests. More complex queries naturally consume more
                            messengers.
                        </p>
                        <div class="grid md:grid-cols-3 gap-6">
                            <div
                                class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-blue-100 dark:border-blue-900 hover:shadow-lg hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-300 transform hover:-translate-y-1">
                                ...
                                <p class="text-gray-600 dark:text-gray-400">
                                    <strong class="text-purple-600 dark:text-purple-400">100-500</strong> messengers per
                                    conversation
                                </p>
                                <p class="text-xs text-gray-500 dark:text-gray-500 mt-2">Quick responses and short
                                    queries</p>
                            </div>
                            <div
                                class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-blue-100 dark:border-blue-900 hover:shadow-lg hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-300 transform hover:-translate-y-1">
                                ...
                                <p class="text-gray-600 dark:text-gray-400">
                                    <strong class="text-green-600 dark:text-green-400">500-2,000</strong> messengers per
                                    quiz
                                </p>
                                <p class="text-xs text-gray-500 dark:text-gray-500 mt-2">Depends on number of
                                    questions</p>
                            </div>
                            <div
                                class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-blue-100 dark:border-blue-900 hover:shadow-lg hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-300 transform hover:-translate-y-1">
                                <div class="flex items-center gap-3 mb-4">
                                    ...
                                    <h4 class="font-semibold text-gray-900 dark:text-white text-lg">Content
                                        Analysis</h4>
                                </div>
                                <p class="text-gray-600 dark:text-gray-400">
                                    <strong class="text-orange-600 dark:text-orange-400">200-1,000</strong> messengers
                                    per document
                                </p>
                    ...
                    <div class="mb-8 animate-fadeIn" style="animation-delay: 0.6s;">
                        ...
                        <div class="max-w-4xl mx-auto" x-data="{ openFaq: null }" @keydown.escape="openFaq = null">
                            <div class="space-y-4">
                                {{-- FAQ Item 1 --}}
                                <div
                                    class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-700 overflow-hidden transition-all duration-300 shadow-sm hover:shadow-md">
                                    <button
                                        ...
                                        <div class="flex items-start gap-4 text-left">
                                            <div
                                                class="flex items-center justify-center w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-400 flex-shrink-0 font-bold text-sm mt-0.5">
                                                Q
                                            </div>
                                        ...
                                        <svg
                                            class="w-6 h-6 text-gray-600 dark:text-gray-400 flex-shrink-0 transition-transform duration-300"
                                    ...
                                    <div x-show="openFaq === 1" x-transition class="px-6 pb-6">
                                        <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                                            Yes! Your purchased messengers can be used for the selected period. Trial
                                            messengers last for 7 days from activation.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div x-show="openFaq === 2" x-transition class="px-6 pb-6">
                                        <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                                            Absolutely! You can purchase additional messenger packages at any time. Your
                                            new messengers will be added to your existing balance, and you'll maintain
                                            all previously purchased messengers.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div x-show="openFaq === 3" x-transition class="px-6 pb-6">
                                        <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                                            Both plans give you the same features and functionality. The difference is
                                            in the messenger count and price. The Premium plan offers more messengers
                                            for better value and longer usage.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div x-show="openFaq === 4" x-transition class="px-6 pb-6">
                                        <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                                            Yes! We use Paystack, a PCI-DSS compliant payment processor. Your payment
                                            information is fully encrypted, secure, and never stored on our servers.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div x-show="openFaq === 5" x-transition class="px-6 pb-6">
                                        <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                                            You can purchase more messengers anytime! Simply return to this page and buy
                                            another package. We'll notify you when your messengers are running low.
                                        </p>
                                    </div>
                                </div>
                            </div>
