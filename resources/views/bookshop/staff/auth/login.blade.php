<x-bookshop::layouts.guest :heading="'BookShop Staff'" :subheading="'Sign in to manage your branch'">
    @if($errors->any())
    ...
    <form method="POST" action="{{ route('bookshop.staff.login') }}" class="space-y-5">
        @csrf
