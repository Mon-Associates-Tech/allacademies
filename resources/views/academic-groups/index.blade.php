    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <x-academic-header>
            ...
            <x-slot name="headerContent">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-xl sm:text-2xl font-bold text-gray-800 dark:text-white">Academic Groups</h1>
                        <p class="text-gray-600 dark:text-gray-400 text-sm mt-1">Manage your educational hierarchies</p>
                    </div>
                </div>
            </x-slot>
            ...
            <x-slot name="headerActions">
                <div class="flex flex-col sm:flex-row gap-2">
                    <a href="{{ route('academic.structure') }}"
                       class="inline-flex items-center px-3 py-2 text-sm font-medium rounded-lg bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors duration-150">
                        ...
                        <span class="hidden sm:inline">View Structure</span>
                        <span class="sm:hidden">Structure</span>
                    </a>

                    @can('administrate')
                        <a href="{{ route('academic-groups.create') }}"
                           class="inline-flex items-center px-3 py-2 text-sm font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 transition-colors duration-150">
                            <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-700 dark:to-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-600 shadow-sm">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $academicGroups->total() }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-gray-700 dark:to-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-600 shadow-sm">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Total Levels</p>
                                <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $academicGroups->sum(function($group) { return $group->academicLevels()->count(); }) }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-purple-50 to-violet-50 dark:from-gray-700 dark:to-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-600 shadow-sm">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $academicGroups->sum(function($group) { return $group->teachers()->count(); }) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="border-t border-gray-200 dark:border-gray-700">
                <div class="divide-y divide-gray-200 dark:divide-gray-700" id="groups-container">
                    @foreach ($academicGroups as $academicGroup)
                        <div class="p-6 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-200 group-item border-l-4 border-l-transparent hover:border-l-blue-500"
                                ...
                                <div class="flex items-center space-x-2 sm:ml-6 sm:space-x-3">
                                    ...
                                    @can('administrate')
                                        <a href="{{ route('academic-groups.edit', ['academic_group' => $academicGroup]) }}"
                                           class="inline-flex items-center px-3 py-2 text-sm font-medium rounded-lg bg-white dark:bg-gray-700 border border-amber-300 dark:border-amber-600 text-amber-700 dark:text-amber-300 hover:bg-amber-50 dark:hover:bg-amber-900/20 transition-colors duration-150">
                                            <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <button type="button"
                                                ...
                                                x-on:click="$store.deleteForm.show(
                                                    ...
                                                    '⚠️ Are you sure you want to delete this academic group?\n\nThis action cannot be undone and will affect all associated levels and teachers.',
                                                    '{{ route('academic-groups.destroy', ['academic_group' => $academicGroup]) }}'
                                                )"
        ...
        @else
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 text-center py-16 px-6">
                ...
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">No Academic Groups Yet</h3>
                <p class="text-gray-600 dark:text-gray-400 mb-8 max-w-md mx-auto">
                    Get started by creating your first academic group to organize your educational structure.
                </p>
                @can('administrate')
                    <div class="space-y-4">
                        <a href="{{ route('academic-groups.create') }}"
                           class="inline-flex items-center px-6 py-3 bg-blue-600 dark:bg-blue-500 text-white font-medium rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors duration-150">
                        ...
                        <div class="text-sm text-gray-500 dark:text-gray-400">
                            <p>✨ Start building your educational hierarchy</p>
                        </div>
                    </div>
                @endcan
            </div>
