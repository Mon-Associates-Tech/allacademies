<x-layouts.app>
    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
                <form method="POST" action="{{ route('admin.school-payment-structures.store') }}" class="p-6 space-y-6">
                    @csrf
                            ...
                            <div>
                                ...
                                <select name="payment_period"
                                    ...
                                    @foreach($payment_periods as $key => $label)
                                        <option value="{{ $key }}" {{ old('payment_period') == $key ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
                            Leave fields empty to apply to all students, or select specific groups/levels
                        </p>
                            ...
                            <div>
                                ...
                                <select name="academic_group_id"
                                    ...
                                    @foreach($academic_groups as $group)
                                        <option value="{{ $group->id }}" {{ old('academic_group_id') == $group->id ? 'selected' : '' }}>
                                            {{ $group->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="space-y-4">
                            ...
                            <div id="partial_amount_field" style="display: none;">
                                ...
                                <input type="number"
                                       ...
                                       value="{{ old('minimum_partial_amount') }}"
                                       step="0.01"
                                       min="0"
                                       placeholder="0.00"
                    ...
                    <div>
                        ...
                        <textarea name="description"
                                  ...
                                  class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-violet-500 focus:border-violet-500">{{ old('description') }}</textarea>
                    </div>
    ...
    <script>
        ...
        if (document.getElementById('allow_partial_payment').checked) {
            document.getElementById('partial_amount_field').style.display = 'block';
        }
    </script>
</x-layouts.app>
