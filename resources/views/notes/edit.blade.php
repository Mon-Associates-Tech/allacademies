            ...
            <form method="POST" action="{{ isset($note) ? route('notes.update', $note) : route('notes.store') }}">
                ...
                <div class="px-6 py-6 sm:px-8 space-y-6">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox"
                                       ...
                                       id="add_to_calendar"
                                       {{ old('add_to_calendar') || $note->calendarEvent ? 'checked' : '' }}
                        ...
                        <div id="calendar-fields" class="mt-4 space-y-4" style="{{ old('add_to_calendar') || $note->calendarEvent ? '' : 'display: none;' }}">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="datetime-local"
                                           ...
                                           value="{{ old('calendar_event_start_date', $note->calendarEvent ? $note->calendarEvent->start_date->format('Y-m-d\\TH:i') : '') }}"
                                ...
                                <div>
                                    ...
                                    <input type="datetime-local"
                                           ...
                                           value="{{ old('calendar_event_end_date', $note->calendarEvent ? $note->calendarEvent->end_date?->format('Y-m-d\\TH:i') : '') }}"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="flex items-center">
                                    <input type="checkbox"
                                           ...
                                           {{ old('calendar_event_all_day', $note->calendarEvent ? $note->calendarEvent->all_day : false) ? 'checked' : '' }}
                                           class="h-4 w-4 text-blue-600 border-gray-300 dark:border-gray-600 rounded focus:ring-blue-500 dark:focus:ring-offset-gray-800">
                                ...
                                <div>
                                    ...
                                    <input type="color"
                                           ...
                                           value="{{ old('calendar_event_color', $note->calendarEvent ? $note->calendarEvent->color : '#3b82f6') }}"
                            ...
                            <div>
                                ...
                                <select name="calendar_event_visibility"
                                    ...
                                    <option value="private" {{ old('calendar_event_visibility', $note->calendarEvent ? $note->calendarEvent->visibility : 'private') === 'private' ? 'selected' : '' }}>Private</option>
                                    <option value="public" {{ old('calendar_event_visibility', $note->calendarEvent ? $note->calendarEvent->visibility : 'private') === 'public' ? 'selected' : '' }}>Public</option>
                                    <option value="shared" {{ old('calendar_event_visibility', $note->calendarEvent ? $note->calendarEvent->visibility : 'private') === 'shared' ? 'selected' : '' }}>Shared</option>
                                </select>
