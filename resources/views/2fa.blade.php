<x-app>
    <main
        class="font-sans antialiased bg-gradient-to-br from-slate-100 via-gray-100 to-slate-200 dark:from-gray-900 dark:via-slate-900 dark:to-gray-950">
            ...
            <div class="max-w-md w-full space-y-8">
                ...
                <div class="relative">
                    <div class="absolute inset-0 flex items-center justify-center">
                        <div
                            class="w-24 h-24 rounded-full bg-slate-200/40 dark:bg-slate-800/40 animate-ping opacity-20"></div>
                    </div>
                    <div class="absolute inset-0 flex items-center justify-center">
                        <div class="w-20 h-20 rounded-full bg-slate-300/30 dark:bg-slate-700/30 animate-pulse"></div>
                    </div>
                    <div
                        class="relative mx-auto h-16 w-16 flex items-center justify-center rounded-2xl bg-gradient-to-br from-slate-700 to-slate-900 dark:from-slate-600 dark:to-slate-800 shadow-xl shadow-slate-500/20">
                    ...
                    <p class="mt-3 text-center text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                        ...
                        <br>
                        <span
                            class="font-semibold text-slate-800 dark:text-slate-300 inline-block mt-1.5">{{ session('2fa:user:email') ?? 'your registered email' }}</span>
                    </p>
                </div>

                <!-- Verification Form with glassmorphism -->
                <div
                    class="relative backdrop-blur-xl bg-white/80 dark:bg-slate-800/80 rounded-3xl shadow-2xl shadow-slate-400/10 dark:shadow-slate-900/50 p-8 border border-slate-200/50 dark:border-slate-700/50">
                    <!-- Decorative gradient corner -->
                    <div
                        class="absolute -top-1 -right-1 w-32 h-32 bg-gradient-to-br from-slate-400/20 to-transparent dark:from-slate-600/20 rounded-3xl blur-2xl"></div>
                    <div
                        class="absolute -bottom-1 -left-1 w-32 h-32 bg-gradient-to-tr from-slate-400/20 to-transparent dark:from-slate-600/20 rounded-3xl blur-2xl"></div>

                    <form method="POST" action="{{ route('2fa.verify') }}" class="relative space-y-6"
                          id="twoFactorForm">
                        @csrf
                        <div>
                            <label for="code"
                            ...
                            <div class="relative group">
                                ...
                                >
                                <div
                                    class="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none opacity-40 group-focus-within:opacity-70 transition-opacity">
                                    <svg class="h-5 w-5 text-slate-500 dark:text-slate-400" fill="none"
                            ...
                            @error('code')
                            <div
                                class="mt-3 text-sm text-red-600 dark:text-red-400 flex items-center bg-red-50 dark:bg-red-900/20 p-3 rounded-xl border border-red-200 dark:border-red-800/50">
                        ...
                        <div class="text-center">
                            <div
                                class="inline-flex items-center justify-center px-4 py-2.5 bg-slate-100 dark:bg-slate-900/50 rounded-xl border border-slate-200 dark:border-slate-700/50">
                                ...
                                Code expires in: <span id="countdown"
                                                       class="font-mono font-bold text-slate-800 dark:text-slate-300 ml-1">15:00</span>
                            </span>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <span class="absolute left-0 inset-y-0 flex items-center pl-4">
                                <svg class="h-5 w-5 text-slate-400 group-hover:text-slate-300 transition-colors"
                        ...
                        <div class="pt-2">
                            <div class="relative">
                                ...
                                <div class="relative flex justify-center text-xs uppercase">
                                    <span
                                        class="bg-white dark:bg-slate-800/80 px-3 text-slate-500 dark:text-slate-400 font-medium">Or</span>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 text-center">
                                ...
                                <div id="resendCooldown"
                                     class="hidden mt-2 inline-flex items-center px-3 py-1.5 bg-slate-100 dark:bg-slate-900/50 rounded-lg border border-slate-200 dark:border-slate-700/50">
                                    <svg class="w-3.5 h-3.5 mr-1.5 text-slate-500 dark:text-slate-400" fill="none"
                                         stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                              d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                    </svg>
                    ...
                    <div class="mt-8 pt-6 border-t border-slate-200 dark:border-slate-700/50 text-center">
                        <a href="{{ route('login') }}"
                           class="inline-flex items-center text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 transition-colors group">
