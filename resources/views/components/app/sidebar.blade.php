                               ...
                               href="{{ route('sponsor.dashboard') }}">
                                <div class="flex items-center">
                                    <svg
                                        ...
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
                                        <path d="M9 11.75A2.25 2.25 0 116.75 9 2.25 2.25 0 019 11.75zm0 1.5a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5zM12.75 12a2.25 2.25 0 112.25-2.25A2.25 2.25 0 0112.75 12zm0 1.5a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5zM8.25 16.5A2.25 2.25 0 116 14.25a2.25 2.25 0 012.25 2.25zm0 1.5a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5zM15.75 18a2.25 2.25 0 112.25-2.25A2.25 2.25 0 0115.75 18zm0 1.5a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5z" fill="currentColor"/>
                                    </svg>
