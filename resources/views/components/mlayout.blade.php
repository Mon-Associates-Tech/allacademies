    ...
    <div class="w-full min-h-screen mx-auto max-w-7xl py-8 px-2 lg:px-0 space-y-5">
        <div class="flex justify-between items-center bg-white rounded-xl px-4 py-3 shadow print:hidden">
            ...
            <div class='flex items-center justify-between w-2 opacity-0 md:opacity-100 md:w-1/2 text-md'>
                ...
                <x-nav-link :active="request()->routeIs('dashboard')" href="{{ route('dashboard') }}" class='text-md font-semibold hover:text-blue-400 '>Dashboard</x-nav-link>
                <x-nav-link :active="request()->routeIs('subscriptions.index')" href="{{ route('subscriptions.index') }}" class='text-md font-semibold hover:text-blue-400 '>Subscriptions</x-nav-link>
                <x-nav-link :active="request()->routeIs('teams.index')" href="{{ route('teams.index') }}" class='text-md font-semibold hover:text-blue-400 '>Team</x-nav-link>
                <x-nav-link :active="request()->routeIs('profile.show')" href="{{ route('profile.show') }}"  class='text-md font-semibold hover:text-blue-400 '>Profile</x-nav-link>
            </div>
        ...
        <div class="print:hidden">
            ...
            <section class="max-w-[80rem] mx-auto">
                <div class="mt-2 md:flex md:items-center md:justify-between max-w-6xl mx-auto">
                    <div class="flex-1 min-w-0 ">
                        <h2 class="text-xl text-start font-bold leading-7 text-gray-900 sm:text-2xl sm:truncate">
                            {{ $title }}
                        </h2>
                    </div>
