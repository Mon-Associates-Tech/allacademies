        ...
        <div class="flex items-center justify-between h-16">
            <div class="flex items-center space-x-1">
                ...
                <a href="{{ route('examination-hub.live-monitoring.all-exams') }}"
                   class="px-4 py-2 rounded-lg text-sm font-medium transition-colors {{ $active === 'live-monitoring' ? 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900 dark:text-indigo-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @endif
                    ...
                    <a href="{{ route('examination-hub.participant-groups.index') }}"
                       class="px-4 py-2 rounded-lg text-sm font-medium transition-colors {{ $active === 'participant-groups' ? 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900 dark:text-indigo-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
