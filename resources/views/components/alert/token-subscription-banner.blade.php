...
@php
    ...
    if (auth()->check()) {
               ...
               try {
                   ...
                   $has_token_subscription = $user->subscriptionCycles()->whereStatus('active')->exists();
...
@if(auth()->check() && !$has_token_subscription ?? false)
    <div class="fixed inset-0 z-40 pointer-events-none"
                ...
                <div class="max-w-md w-full bg-white dark:bg-slate-800 rounded-lg shadow-2xl p-8">
                    <div class="flex justify-center mb-6">
                        <div class="flex-shrink-0">
                            <svg class="h-12 w-12 text-amber-400 dark:text-amber-500" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <p class="text-center text-slate-600 dark:text-slate-400 mb-6">
                        You need an active messenger subscription to access this feature. Please subscribe to continue
                        using this service.
                    </p>
        ...
        @else
            ...
            <div
                class="fixed top-0 left-0 right-0 z-50 bg-amber-50  ml-auto dark:bg-amber-950 border-b-4 border-amber-400 dark:border-amber-500 p-4 shadow-lg pointer-events-auto"
                role="alert">
                <div class="flex items-start max-w-7xl mx-auto">
                    <div class="flex-shrink-0">
                        <svg class="h-5 w-5 text-amber-400 dark:text-amber-500" xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                            <path fill-rule="evenodd"
                                  d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z"
                                  clip-rule="evenodd"/>
                    ...
                    <div class="ml-3 flex-1">
                        ...
                        <p class="mt-2 text-sm text-amber-700 dark:text-amber-300">
                            You need an active messenger subscription to access this feature. Please subscribe to
