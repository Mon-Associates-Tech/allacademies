@php
    ...
    $mainOnly = (!$hasLeft || !$hasRight) && isset($mainOnly);
@endphp


@props(['title' => null, 'action' => null, 'breadcrumb' => null, 'action_link' => '', 'hasAction' => true, 'pageName' => ''])
...
<x-app page-name="{{$pageName ?: $title}}">
        ...
        <div class="flex justify-between items-center bg-white rounded-xl px-4 py-3 shadow print:hidden">
            ...
            <div class='flex items-center justify-between w-2 opacity-0 md:opacity-100 md:w-1/2 text-md'>
                ...
                <x-nav-link :active="request()->routeIs('dashboard')" href="{{ route('dashboard') }}"
                            class='text-md font-semibold hover:text-blue-400 '>Dashboard
                </x-nav-link>
                <x-nav-link :active="request()->routeIs('subscriptions.index')"
                            href="{{ route('subscriptions.index') }}"
                            class='text-md font-semibold hover:text-blue-400 '>Subscriptions
                </x-nav-link>
                <x-nav-link :active="request()->routeIs('teams.index')" href="{{ route('teams.index') }}"
                            class='text-md font-semibold hover:text-blue-400 '>Team
                </x-nav-link>
                <x-nav-link :active="request()->routeIs('profile.show')" href="{{ route('profile.show') }}"
                            class='text-md font-semibold hover:text-blue-400 '>Profile
                </x-nav-link>
            </div>
...
{{--            <x-link.secondary :to="route('back')">Back</x-link.secondary>--}}
    ...
    'max-w-[90rem]',
                ...
                @if ($hasLeft && $hasRight)
                    ...
                    <div class="col-span-3">
                        <div class="flex justify-between py-2 print:hidden">
                            <div class="font-bold pl-1">{{$action}}</div>
                        </div>
                        <div>{{ $right }}</div>
                    </div>
