...
<div class="space-y-1">
    ...
    >
        ...
        <textarea x-model.lazy="down" x-show="!preview" id="{{ $name }}_down" name="{{ $name }}[down]" {{ $attributes->merge(['class' => 'border-gray-300 rounded-lg shadow-sm w-full leading-tight']) }}>{{ old($name, $value) }}</textarea>
