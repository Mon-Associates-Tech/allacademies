<x-layouts.app>
    <div class="py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Header -->
            <div class="mb-6">
                <a href="{{ route('teachers.public-assignments.show', $assignment) }}" class="text-sm text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 flex items-center gap-1 mb-2">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
                <form action="{{ route('teachers.public-assignments.show', $assignment) }}" method="GET" id="editForm">
                    <!-- Basic Information -->
                    <div class="mb-8">
                    ...
                    <div class="flex items-center justify-between pt-6 border-t border-gray-200 dark:border-gray-700">
                        <a href="{{ route('teachers.public-assignments.show', $assignment) }}" class="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
                            Cancel
                        </a>
                        <div class="flex gap-3">
                            @if($assignment->status === 'draft')
                                <form action="{{ route('teachers.public-assignments.publish', $assignment) }}" method="POST" class="inline">
                                    @csrf
                            ...
                            @elseif($assignment->status === 'published')
                                <form action="{{ route('teachers.public-assignments.close', $assignment) }}" method="POST" class="inline">
                                    @csrf
            ...
            <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                <a href="{{ route('teachers.public-assignments.results', $assignment) }}" class="p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 hover:border-indigo-500 transition-colors">
                ...
                <a href="{{ route('public-assignments.join.code', $assignment->access_code) }}" target="_blank" class="p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 hover:border-indigo-500 transition-colors">
                    <div class="flex items-center gap-3">
                ...
                <button onclick="navigator.clipboard.writeText('{{ route('public-assignments.join.code', $assignment->access_code) }}')" class="p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 hover:border-indigo-500 transition-colors text-left">
                    <div class="flex items-center gap-3">
