        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                ...
                <div class="flex items-center gap-3">
                    <a href="{{ route('teachers.general-exams.edit', $assignment) }}" class="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
                        Edit
                    </a>
                    <a href="{{ route('teachers.general-exams.results', $assignment) }}" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg transition-colors">
                        View Results
                    </a>
                </div>
            </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="flex items-center gap-2 mt-2">
                            <span class="text-base font-semibold text-white">{{ route('general-exams.join.code', $assignment->access_code) }}</span>
                ...
                <div class="space-y-4">
                    ...
                    @empty
                        <div class="text-center py-8 text-gray-500 dark:text-gray-400">
                            ...
                            <a href="{{ route('teachers.general-exams.edit', $assignment) }}" class="text-indigo-600 hover:text-indigo-700 mt-2 inline-block">Add questions</a>
                        </div>
                    @endforelse
                </div>
            </div>
