    ...
    <div x-data="{
        ...
        <div class="mb-12 max-w-2xl mx-auto">
            <div class="relative">
                <input type="text"
                       ...
                       class="w-full px-6 py-4 pl-14 text-gray-900 dark:text-white bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-lg transition-all">
        ...
        <div class="mb-12 flex flex-wrap justify-center gap-3">
            <button @click="selectedCategory = 'all'"
                    ...
                    class="px-6 py-3 rounded-xl text-sm font-semibold transition-all duration-200 hover:scale-105">
                All Questions
            </button>
        ...
        <div x-show="filteredFaqs.length === 0" class="text-center py-16">
            ...
            <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">No questions found</h3>
            <p class="text-gray-600 dark:text-gray-400 mb-6">Try adjusting your search or filters</p>
            <button @click="clearFilters()" class="px-6 py-3 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-colors">
                Clear Filters
            </button>
        </div>
        ...
        <div class="space-y-3">
            <template x-for="faq in filteredFaqs" :key="faq.id">
                <div class="bg-white dark:bg-gray-800 rounded-xl border-2 border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-300 hover:border-blue-500 dark:hover:border-blue-400">
                    <button @click="openFaq = openFaq === faq.id ? null : faq.id"
                            class="w-full px-6 py-5 text-left flex justify-between items-center hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                        <span class="text-lg font-bold text-gray-900 dark:text-white pr-8" x-text="faq.question"></span>
                    ...
                    <div x-show="openFaq === faq.id"
                         ...
                         class="px-6 pb-6 bg-gray-50 dark:bg-gray-900/50">
                        <div class="pt-4 pl-4 border-l-4 border-blue-500">
                            <p class="text-base text-gray-700 dark:text-gray-300 leading-relaxed" x-text="faq.answer"></p>
                        </div>
                    </div>
                </div>
            </template>
        ...
        <div class="mt-20 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-900 rounded-3xl p-12 text-center border border-gray-200 dark:border-gray-700">
            ...
            <h3 class="text-3xl font-black text-gray-900 dark:text-white mb-3">Still have questions?</h3>
            <p class="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">Can't find the answer you're looking for? Our support team is ready to help.</p>
            <a href="{{route('branding.contact')}}" class="inline-flex items-center px-8 py-4 bg-blue-600 text-white font-bold text-lg rounded-2xl hover:bg-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
