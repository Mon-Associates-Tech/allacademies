...
<div class="py-12 bg-gray-50 dark:bg-gray-900 min-h-screen">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Back Link -->
        <a href="{{ route('sponsorship.programs.index') }}" class="inline-flex items-center text-violet-600 hover:text-violet-700 mb-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 mb-8">
            <div class="flex items-start justify-between mb-4">
                <div>
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-violet-100 text-violet-800 dark:bg-violet-900 dark:text-violet-200 mb-2">
                        {{ $program->code }}
                    </span>
            ...
            <div class="space-y-2">
                <div class="flex justify-between text-sm font-medium">
                    <span class="text-gray-500 dark:text-gray-400">Raised: GHS {{ number_format($program->amount_raised, 2) }}</span>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
            ...
            <form action="{{ route('sponsorship.programs.contribute.initialize', $program) }}" method="POST" id="donationForm">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <div class="flex flex-wrap gap-2 mt-3">
                        @foreach([50, 100, 200, 500, 1000] as $quickAmount)
                            <button type="button" onclick="document.getElementById('amount').value = {{ $quickAmount }}; updateFeeBreakdown();"
                ...
                <div class="mb-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                    <div class="flex items-start">
                        ...
                        <div class="text-sm">
                            <p class="font-medium text-blue-800 dark:text-blue-200">Platform Fee: {{ $platformFeePercentage }}</p>
                            <p class="text-blue-600 dark:text-blue-300 mt-1">
                                A small platform fee helps us maintain and improve our services. You can choose to cover this fee so the benefactor receives the full amount.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div id="feeBreakdown" class="mb-6 bg-gray-50 dark:bg-gray-700 rounded-lg p-4 hidden">
                    ...
                    <div class="space-y-2 text-sm">
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium text-gray-900 dark:text-white" id="displayAmount">GHS 0.00</span>
                        </div>
                        <div class="flex justify-between">
                ...
                <div class="space-y-4 mb-6">
                    <div>
                        ...
                        <input type="text" name="payer_name" value="{{ old('payer_name', auth()->user()->name ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="email" name="payer_email" value="{{ old('payer_email', auth()->user()->email ?? '') }}"
                               class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-violet-500 focus:ring-violet-500"
