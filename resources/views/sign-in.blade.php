<x-app>
    ...
    <section class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 relative overflow-hidden transition-colors duration-300">
        <!-- Animated background elements -->
        <div class="absolute inset-0">
            <div class="absolute top-1/4 left-1/4 w-32 h-32 md:w-64 md:h-64 bg-blue-200 dark:bg-blue-900/30 rounded-full mix-blend-multiply dark:mix-blend-normal filter blur-xl opacity-70 animate-blob"></div>
            <div class="absolute top-1/3 right-1/4 w-32 h-32 md:w-64 md:h-64 bg-green-200 dark:bg-green-900/30 rounded-full mix-blend-multiply dark:mix-blend-normal filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
            <div class="absolute bottom-1/4 left-1/3 w-32 h-32 md:w-64 md:h-64 bg-orange-200 dark:bg-orange-900/30 rounded-full mix-blend-multiply dark:mix-blend-normal filter blur-xl opacity-70 animate-blob animation-delay-4000"></div>
        </div>
        ...
        <div class="lg:grid lg:min-h-screen lg:grid-cols-12 relative z-10">
            ...
            <aside class="relative block h-32 sm:h-48 lg:order-last lg:col-span-5 lg:h-full xl:col-span-6">
                <div class="absolute inset-0 bg-gradient-to-br from-blue-600/20 to-green-600/20 dark:from-blue-800/40 dark:to-green-800/40 backdrop-blur-sm"></div>
                <img
                ...
                <div class="absolute bottom-4 left-4 right-4 sm:bottom-8 sm:left-8 sm:right-8 text-white lg:bottom-16 lg:left-16 lg:right-16">
                    <h2 class="text-xl sm:text-2xl font-bold lg:text-4xl mb-2 lg:mb-4">Join thousands of students</h2>
                    <p class="text-sm sm:text-lg opacity-90 mb-4 lg:mb-6">Learning and growing with All Academies every day</p>
            ...
            <!-- Form section -->
            <main class="flex items-center justify-center px-4 sm:px-8 py-8 sm:py-12 lg:col-span-7 lg:px-16 xl:col-span-6">
                <div class="w-full max-w-md">
                    <!-- Logo and branding -->
                    <div class="mb-6 sm:mb-8">
                        <div class="flex items-center gap-3 mb-4 sm:mb-6">
                            <img class="h-8 sm:h-10 w-auto" src="{{ asset('img/logo.png') }}" alt="{{ config('app.name') }} Logo">
                    ...
                    <form method="POST" action="{{ route('sign-in') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                >
                                    <svg id="password-eye-closed" class="h-5 w-5 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                    </svg>
                                    <svg id="password-eye-open" class="hidden h-5 w-5 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L8.464 8.464M9.878 9.878l.914-.914M4.464 4.464l15.072 15.072"/>
                                    </svg>
                                </button>
                            </div>
                            @error('password')
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                >
                                <label for="remember" class="ml-2 block text-sm text-gray-700 dark:text-gray-200 transition-colors duration-300">
                                    Remember me
                                </label>
                            </div>
                            <a href="{{ route('password.request') }}" class="text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 transition-colors duration-300">
                                Forgot password?
                            </a>
                        </div>
                        ...
                        >
                            <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                              <svg class="h-5 w-5 text-white/75 group-hover:text-white transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="mt-6 sm:mt-8 text-center">
                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-3 transition-colors duration-300">Trusted by students worldwide</p>
