<section
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            <div class="mb-8 sm:mb-12 lg:mb-0">
                <div
                    class="inline-flex items-center px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-violet-100 dark:bg-violet-900/30 text-violet-800 dark:text-violet-200 font-semibold text-xs sm:text-sm mb-4 sm:mb-6">
                ...
                <h2 class="text-2xl sm:text-3xl font-bold sm:font-extrabold text-gray-900 dark:text-white lg:text-4xl mb-4 sm:mb-6">
                    Help Educate a <span
                        class="text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-purple-600"> Needy Child</span>
                </h2>
                <p class="text-base sm:text-lg lg:text-xl text-gray-600 dark:text-gray-300 mb-6 sm:mb-8 leading-relaxed">
