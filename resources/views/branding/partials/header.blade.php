    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div x-data="{ open: false }" class="flex justify-between items-center h-16 lg:h-20">
            ...
            <nav class="hidden lg:flex items-center space-x-8">
                <!-- New Organize Mock Link -->
                <a href="{{ route('mock-exams.index') }}"
                class="font-semibold transition-colors duration-300 relative group flex items-center text-sm"
                ...
                <div class="hidden lg:flex items-center gap-3">
                    ...
                    @auth
                        ...
                        <a href="{{ route('dashboard') }}"
                           class="inline-flex items-center px-6 py-3 font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-sm"
                    ...
                    <div class="mt-6 flow-root">
                        <div class="-my-6 divide-y divide-gray-500/10 dark:divide-gray-400/10">
                            <div class="space-y-2 py-6">
                                <!-- New Organize Mock Link -->
                                <a href="{{ route('mock-exams.index') }}"
                                class="-mx-3 block rounded-lg px-3 py-2 text-sm font-semibold leading-7 text-gray-900 dark:text-gray-100 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors"
                                x-on:click="open = false">Organize Mock</a>
                            ...
                            <div class="py-6 space-y-3">
                                @auth
                                    <a href="{{ route('dashboard') }}"
                                       class="-mx-3 block rounded-lg px-3 py-2.5 text-sm font-semibold leading-7 text-center text-white bg-gradient-to-r from-blue-600 to-green-600 hover:shadow-lg transition-all">
                                        Dashboard
                                    </a>
                                @else
                                    <a href="{{ route('login') }}"
