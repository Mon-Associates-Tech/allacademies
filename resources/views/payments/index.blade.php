    ...
    <x-table>
        ...
        @foreach ($payments as $payment)
            <tr>
                ...
                <x-table.td><span class="inline-flex items-center rounded-md bg-green-100 px-2 py-1 text-xs font-medium text-green-700 capitalize">{{ $payment->status }}</span></x-table.td>
            </tr>
        @endforeach
    </x-table>
