<x-layouts.general-exam title="Assignment Results" pageName="Results">
...
{{--                                    <p class="text-gray-900 dark:text-white mb-3">{{ $question->question }}</p>--}}
                ...
                <div class="mt-6 text-center">
                    @if($submission->assignment->max_attempts > ($submission->attempt_number ?? 1) && $submission->assignment->status === 'published')
                        <a href="{{ route('general-exams.join.code', $submission->assignment->access_code) }}" class="inline-flex items-center px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-xl transition-colors">
                            Try Again
                        </a>
                    @endif
                    <a href="{{ route('general-exams.join') }}" class="inline-flex items-center px-6 py-3 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-medium rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors ml-3">
