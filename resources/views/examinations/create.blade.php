<x-auth title="Create Examination" :has-action="false">
    ...
    <div class="">
        <form method="POST" enctype="multipart/form-data"
            ...
            <div class="grid sm:grid-cols-7 gap-4 place-items-center">
            ...
            <div class="grid sm:grid-cols-7 place-items-center">
                <div class="sm:col-span-1"></div>
                <div class="sm:col-span-5">
