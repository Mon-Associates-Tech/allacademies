    ...
    <div class="py-6">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                ...
                <a href="{{ route('public-assignments.join') }}" class="inline-flex items-center justify-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg transition-colors">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                                ...
                                <div class="flex items-start justify-between gap-4">
                                    ...
                                    <div class="flex items-center gap-4">
                                        ...
                                        @if($submission->status === 'in_progress')
                                            <a href="{{ route('public-assignments.take', $submission) }}" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition-colors">
                                                Continue
                                            </a>
                                        @elseif($submission->status === 'completed' || $submission->status === 'graded')
                                            <a href="{{ route('student.public-assignments.result', $submission) }}" class="px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                                View Result
                                            </a>
                                        @endif
                                    </div>
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <a href="{{ route('public-assignments.join') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg">
                            Join an Assignment
                        </a>
                    </div>
                @endif
