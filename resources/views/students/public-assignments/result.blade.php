<x-layouts.app>
    <div class="py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Header -->
            <div class="mb-6">
                <a href="{{ route('student.public-assignments.index') }}" class="text-sm text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 flex items-center gap-1 mb-2">
            ...
            <div class="mt-6 flex items-center justify-between">
                <a href="{{ route('student.public-assignments.index') }}" class="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
                    ← Back to Assignments
                </a>
                @if($submission->assignment->max_attempts > ($submission->attempt_number ?? 1) && $submission->assignment->status === 'published')
                    <a href="{{ route('public-assignments.join.code', $submission->assignment->access_code) }}" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg">
                        Try Again
                    </a>
                @endif
            </div>
