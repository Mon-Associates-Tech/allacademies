        ...
        <section id="home" class="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32 text-center">
                ...
                <div class="flex items-center justify-center space-x-2">
                    ...
                    <span class="text-white font-semibold text-sm sm:text-base lg:text-lg ml-2 sm:ml-3">4.9/5 Rating</span>
                </div>
            </div>
        </section>
        ...
        <section id="features" class="py-16 sm:py-20 lg:py-24 bg-white dark:bg-gray-900 transition-colors duration-300">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="space-y-16 sm:space-y-24 lg:space-y-32">
                    ...
                    <div class="flex flex-col lg:flex-row items-center gap-6 sm:gap-8 lg:gap-16 px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="lg:w-1/2 space-y-3 sm:space-y-4 lg:space-y-6 w-full">
                            <div class="flex items-center space-x-3 sm:space-x-4">
                                ...
                                <div>
                                    <h3 class="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white">Comprehensive Digital
                                        Library</h3>
                                    <p class="text-sm sm:text-base text-blue-600 dark:text-blue-400 font-semibold">Access Everything,
                                        Anytime</p>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                <div
                                    class="bg-gray-50 dark:bg-gray-800 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-gray-200 dark:border-gray-700">
                                    <div class="flex items-center space-x-2 sm:space-x-3">
                                        <svg class="h-4 w-4 sm:h-5 sm:w-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M5 13l4 4L19 7"></path>
                                        </svg>
                                        <span
                                            class="text-sm sm:text-base text-gray-700 dark:text-gray-300 font-medium">AI-Powered Search</span>
                                    </div>
                                </div>
                                <div
                                    class="bg-gray-50 dark:bg-gray-800 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-gray-200 dark:border-gray-700">
                                    <div class="flex items-center space-x-2 sm:space-x-3">
                                        ...
                                        <span
                                            class="text-sm sm:text-base text-gray-700 dark:text-gray-300 font-medium">Multiple Formats</span>
                                    </div>
                                </div>
                                <div
                                    class="bg-gray-50 dark:bg-gray-800 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-gray-200 dark:border-gray-700">
                                    <div class="flex items-center space-x-2 sm:space-x-3">
                                        ...
                                        <span class="text-sm sm:text-base text-gray-700 dark:text-gray-300 font-medium">Offline Access</span>
                                    </div>
                                </div>
                                <div
                                    class="bg-gray-50 dark:bg-gray-800 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-gray-200 dark:border-gray-700">
                                    <div class="flex items-center space-x-2 sm:space-x-3">
                                        ...
                                        <span class="text-sm sm:text-base text-gray-700 dark:text-gray-300 font-medium">Daily Updates</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col lg:flex-row-reverse items-center gap-6 sm:gap-8 lg:gap-16 px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="lg:w-1/2 space-y-3 sm:space-y-4 lg:space-y-6 w-full">
                            <div class="flex items-center space-x-3 sm:space-x-4">
                                ...
                                <div>
                                    <h3 class="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white">Learn from Industry
                                        Leaders</h3>
                                    <p class="text-sm sm:text-base text-green-600 dark:text-green-400 font-semibold">Verified Expertise</p>
                                </div>
                            </div>
                            ...
                            <div class="space-y-3 sm:space-y-4">
                                <div class="flex items-start space-x-3 sm:space-x-4">
                                    <div class="flex-shrink-0">
                                        <div
                                            class="flex items-center justify-center h-8 w-8 sm:h-10 sm:w-10 rounded-lg bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400">
                                    ...
                                    <div>
                                        <h4 class="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">Verified
                                            Credentials</h4>
                                        <p class="text-sm sm:text-base text-gray-600 dark:text-gray-300">All authors undergo rigorous
                                ...
                                <div class="flex items-start space-x-3 sm:space-x-4">
                                    ...
                                    <div>
                                        <h4 class="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">Direct
                                            Communication</h4>
                                        <p class="text-sm sm:text-base text-gray-600 dark:text-gray-300">Engage directly with authors through
                                ...
                                <div class="flex items-start space-x-3 sm:space-x-4">
                                    ...
                                    <div>
                                        <h4 class="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">Latest
                                            Research</h4>
                                        <p class="text-sm sm:text-base text-gray-600 dark:text-gray-300">Content reflects the most current
                    ...
                    <div class="flex flex-col lg:flex-row items-center gap-6 sm:gap-8 lg:gap-16 px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="lg:w-1/2 space-y-3 sm:space-y-4 lg:space-y-6 w-full">
                            <div class="flex items-center space-x-3 sm:space-x-4">
                                ...
                                <div>
                                    <h3 class="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white">Interactive Learning
                                        Experience</h3>
                                    <p class="text-sm sm:text-base text-purple-600 dark:text-purple-400 font-semibold">Engage &
                                        Collaborate</p>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                <div
                                    class="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-purple-200 dark:border-purple-700">
                                    <div class="flex items-center space-x-2 sm:space-x-3">
                                        <svg class="h-5 w-5 sm:h-6 sm:w-6 text-purple-500 flex-shrink-0" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"></path>
                                        </svg>
                                        <div>
                                            <div class="text-sm sm:text-base font-semibold text-gray-900 dark:text-gray-100">Smart Quizzes
                                            </div>
                                            <div class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Adaptive assessment
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div
                                    ...
                                    <div class="flex items-center space-x-2 sm:space-x-3">
                                        ...
                                        <div>
                                            <div class="text-sm sm:text-base font-semibold text-gray-900 dark:text-gray-100">Study Groups
                                            </div>
                                            <div class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Collaborative
                                                learning
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div
                                    ...
                                    <div class="flex items-center space-x-2 sm:space-x-3">
                                        ...
                                        <div>
                                            <div class="text-sm sm:text-base font-semibold text-gray-900 dark:text-gray-100">Progress
                                                Analytics
                                            </div>
                                            <div class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Track your journey
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div
                                    ...
                                    <div class="flex items-center space-x-2 sm:space-x-3">
                                        ...
                                        <div>
                                            <div class="text-sm sm:text-base font-semibold text-gray-900 dark:text-gray-100">Mobile
                                                Learning
                                            </div>
                                            <div class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Learn anywhere</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <section id="modules"
                        class="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-800 dark:to-gray-900 transition-colors duration-300">
                        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div class="text-center mb-12 sm:mb-16 lg:mb-20 px-4">
                                <div
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
                                ...
                                <div
                                    ...
                                    <div class="space-y-2 sm:space-y-3">
                                        <div class="flex items-center text-xs sm:text-sm text-gray-600 dark:text-gray-300">
                                            <svg class="h-3 w-3 sm:h-4 sm:w-4 text-green-500 mr-2 sm:mr-3 flex-shrink-0" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M5 13l4 4L19 7"></path>
                                            </svg>
                                ...
                                <div
                                    ...
                                    <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-3 sm:mb-4">Teaching</h3>
                                    <p class="text-sm sm:text-base text-gray-600 dark:text-gray-300 mb-4 sm:mb-6 leading-relaxed">
                                ...
                                <div
                                    ...
                                    <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-3 sm:mb-4">Quizzes</h3>
                                    <p class="text-sm sm:text-base text-gray-600 dark:text-gray-300 mb-4 sm:mb-6 leading-relaxed">
                                ...
                                <div
                                    ...
                                    <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-3 sm:mb-4">Examinations</h3>
                                    <p class="text-sm sm:text-base text-gray-600 dark:text-gray-300 mb-4 sm:mb-6 leading-relaxed">
                                ...
                                <div
                                    ...
                                    <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-3 sm:mb-4">Monitoring &
                                        Reporting</h3>
                                    <p class="text-sm sm:text-base text-gray-600 dark:text-gray-300 mb-4 sm:mb-6 leading-relaxed">
                                ...
                                <div
                                    ...
                                    <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-3 sm:mb-4">Books &
                                        Marketplace</h3>
                                    <p class="text-sm sm:text-base text-gray-600 dark:text-gray-300 mb-4 sm:mb-6 leading-relaxed">
                            ...
                            <div
                                ...
                                <div class="text-center mb-8 sm:mb-12">
                                    <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">Additional Platform
                                        Features</h3>
                                    <p class="text-sm sm:text-base text-gray-600 dark:text-gray-300">Explore more tools and features that
                                        enhance your
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4 sm:gap-6">
                                    ...
                                    <div
                                        ...
                                        <h4 class="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white mb-1 sm:mb-2">Content
                                            Management</h4>
                                    ...
                                    <div
                                        ...
                                        <h4 class="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white mb-1 sm:mb-2">Student
                                            Portal</h4>
                                    ...
                                    <div
                                        ...
                                        <h4 class="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white mb-1 sm:mb-2">Teacher
                                            CPD</h4>
                                    ...
                                    <div
                                        ...
                                        <h4 class="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white mb-1 sm:mb-2">Mock
                                            Exams</h4>
                                    ...
                                    <div
                                        ...
                                        <h4 class="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white mb-1 sm:mb-2">National
                                            Curriculum</h4>
                            ...
                            <div class="py-16 sm:py-20 lg:py-24 bg-gradient-to-r">
                                <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                                    ...
                                    <div class="mt-6 sm:mt-8 flex flex-col sm:flex-row items-center justify-center sm:space-x-6 space-y-3 sm:space-y-0 text-xs sm:text-sm">
