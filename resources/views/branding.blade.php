                    ...
                    <div id="demo" class="py-24 bg-gray-50 dark:bg-gray-800 transition-colors duration-300">
                        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div class="text-center mb-16">
                                ...
                                <p class="max-w-3xl text-xl text-gray-600 dark:text-gray-300 mx-auto leading-relaxed">
                                    Take a guided tour through our features and see how we transform the learning experience for students and educators.
                                </p>
                            </div>

                            <div class="relative max-w-5xl mx-auto">
                                <!-- Decorative Elements -->
                                <div class="absolute -top-10 -left-10 w-40 h-40 bg-red-300 dark:bg-red-600/20 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
                                <div class="absolute -bottom-10 -right-10 w-40 h-40 bg-orange-300 dark:bg-orange-600/20 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>

                                <div class="relative rounded-3xl overflow-hidden shadow-2xl border border-gray-200 dark:border-gray-700 bg-gray-900 group">
                                    <!-- Video Player -->
                                    <div class="aspect-w-16 aspect-h-9">
                                        <video class="w-full h-full object-cover" controls preload="none" poster="https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=1200&h=675&fit=crop">
