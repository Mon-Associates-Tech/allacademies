<x-app>
    ...
    <div class="py-24 bg-gradient-to-r from-violet-50 to-purple-50 dark:from-gray-800 dark:to-gray-900 transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
                <div class="mb-12 lg:mb-0">
                    <div class="inline-flex items-center px-4 py-2 rounded-full bg-violet-100 dark:bg-violet-900/30 text-violet-800 dark:text-violet-200 font-semibold text-sm mb-6">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h2 class="text-4xl font-extrabold text-gray-900 dark:text-white sm:text-5xl mb-6">
                        Quick & Secure <span class="text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-purple-600">Fee Payment</span>
                    </h2>
                    <p class="text-xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                        Give a child a chance to learn. Your contribution can cover the fees they cannot.
                        Please, help pay a needy child's school fees.
                    </p>
                ...
                <div class="relative">
                    <!-- Decorative blobs -->
                    <div class="absolute -top-4 -right-4 w-72 h-72 bg-purple-300 dark:bg-purple-900/30 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
                    <div class="absolute -bottom-4 -left-4 w-72 h-72 bg-violet-300 dark:bg-violet-900/30 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>

                    <div class="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-200 dark:border-gray-700 transform rotate-2 hover:rotate-0 transition-all duration-500">
