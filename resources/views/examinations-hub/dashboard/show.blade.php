        ...
        <div class="grid md:grid-cols-2 gap-6 items-start">
            ...
            <div class="space-y-5">
                ...
                <div class="bg-white dark:bg-slate-900 overflow-hidden"
                    ...
                    <div class="p-5">
                        <form action="{{ route('examinations-hub.participants.configured.store', $exam) }}" method="POST" class="space-y-3">
                            @csrf
                            <div>
                ...
                <div class="bg-white dark:bg-slate-900 overflow-hidden"
                    ...
                    <div class="p-5">
                        ...
                        <form action="{{ route('examinations-hub.participants.configured.import', $exam) }}" method="POST" enctype="multipart/form-data" class="space-y-3">
                            @csrf
                            <div>
