@props(['subtopic', 'resources' => [], 'notes' => [], 'todos' => []])
...
<div class="academic-resource-view">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="{{ route('academic-resources.group', $subtopic->academicTopic->academicSubject->academicLevel->academicGroup) }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">{{ $subtopic->academicTopic->academicSubject->academicLevel->academicGroup->name }}</a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
                    ...
                    <a href="{{ route('academic-resources.level', $subtopic->academicTopic->academicSubject->academicLevel) }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">{{ $subtopic->academicTopic->academicSubject->academicLevel->name }}</a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
                    ...
                    <a href="{{ route('academic-resources.subject', $subtopic->academicTopic->academicSubject) }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">{{ $subtopic->academicTopic->academicSubject->name }}</a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
                    ...
                    <a href="{{ route('academic-resources.topic', $subtopic->academicTopic) }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">{{ $subtopic->academicTopic->name }}</a>
                </div>
            </li>
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">{{ $subtopic->name }}</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    {{-- Header --}}
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ $subtopic->name }}</h1>
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
            {{ count($resources) }} resources, {{ count($notes) }} notes, {{ count($todos) }} todos
        </p>
    </div>

    {{-- Tabs --}}
    <div x-data="{ activeTab: 'resources' }" class="mb-6">
