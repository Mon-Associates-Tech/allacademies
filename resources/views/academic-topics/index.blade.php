<x-layouts.app title="Academic Topics">
                ...
                @foreach ($academicTopics as $academicTopic)
                    <tr>
                        ...
                        <x-table.td action>
                            ...
                            @can('administrate')
                                <x-action name="edit"
                                          :to="route('academic-topics.edit', ['academic_topic' => $academicTopic])"/>
                                <x-action name="delete"
                                          :to="route('academic-topics.destroy', ['academic_topic' => $academicTopic])">
