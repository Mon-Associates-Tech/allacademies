<x-center>
    <div class="max-w-md mx-auto space-y-6">
        ...
        <div class="text-center">
            ...
            @endif
            <p class="text-sm text-gray-500">Click the link in the email to verify your account and start using All
                Academies.</p>
        </div>
            ...
            <div class="flex items-start space-x-3">
                ...
                <div class="flex-1">
                    ...
                    <p class="mt-1 text-sm text-yellow-700">
                        If you continue to have issues receiving the verification email, please contact our support team
                        for assistance.
                    </p>
                    <div class="mt-2">
