                    ...
                    <div class="flex items-start space-x-6">
                        ...
                        <div class="flex-shrink-0">
                            <div class="relative">
                                ...
                                @else
                                    <div
                                        class="w-24 h-24 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center border-4 border-white shadow-lg">
                        ...
                        <div class="flex-1 space-y-4">
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3 text-sm">
                                    <label for="force_update_avatar" class="font-medium text-gray-700">Force Update
                                        Avatar</label>
                        ...
                        <div class="md:col-span-2">
                            <div class="relative">
                                <x-form.input
                                    ...
                                    label="Email"
                                    readonly
                                    class=" block w-full bg-gray-50 border-gray-300 rounded-md shadow-sm text-gray-600 cursor-not-allowed"/>
                            </div>
                            <p class="mt-1 text-xs text-gray-500">Email address cannot be changed from this form</p>
                            @if($user->email && !$user->hasVerifiedEmail())
                                <div class="mt-2 flex items-center text-sm text-amber-600">
                                    ...
                                    Email not verified. <a href="{{ route('verification.notice') }}"
                                                           class="underline hover:no-underline">Verify now</a>
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900 font-mono">
                                #{{ str_pad($user->id, 6, '0', STR_PAD_LEFT) }}</dd>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="flex-1">
                    ...
                    <div class="text-sm text-blue-800 space-y-2">
                        <div class="flex items-start space-x-2">
                            ...
                            <div>
                                <strong>Profile Picture:</strong> Use a clear, professional photo that represents you
                                well. Square images work best.
                            </div>
                        </div>
                        <div class="flex items-start space-x-2">
                            <div class="w-1.5 h-1.5 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                            <div>
                                <strong>Email Changes:</strong> If you change your email, you'll need to verify the new
                        ...
                        <div class="flex items-start space-x-2">
                            <div class="w-1.5 h-1.5 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                            <div>
                                <strong>Keep It Updated:</strong> Regular profile updates help ensure you receive
