...
class MockExamSubscription extends Model
{
    use HasFactory, SoftDeletes;

    protected $fillable = [
        'user_id',
        'mock_exam_subscription_plan_id',
        'type',
        'status',
        'participant_slots',
        'participants_used',
    ...
    {
        return [
            'status' => MockExamSubscriptionStatus::class,
    ...
    {
        return $this->belongsTo(MockExamSubscriptionPlan::class, 'general_exam_subscription_plan_id');
    }
    ...
    public function subjects(): BelongsToMany
    {
        return $this->belongsToMany(
            ...
            'mock_exam_subscription_subjects',
    ...
    {
        return $this->hasMany(MockExamSubscriptionPayment::class);
    }
    ...
    {
        return $this->hasMany(MockExam::class, 'mock_exam_subscription_id');
    }
    ...
    {
        $query->where('status', MockExamSubscriptionStatus::Active)
            ->where(function ($q) {
    ...
    {
        if ($this->status !== MockExamSubscriptionStatus::Active) {
            return false;
        }
