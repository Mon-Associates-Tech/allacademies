...
class MultipleChoiceQuestionRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'option_c.up' => [Rule::requiredIf(null != $this->option_d['up']), 'nullable', 'string'],
            'option_c.down' => [Rule::requiredIf(null != $this->option_d['down']), 'nullable', 'string'],
            'option_d' => ['required', 'array'],
            'option_d.up' => [Rule::requiredIf(null != $this->option_e['up']), 'nullable', 'string'],
            'option_d.down' => [Rule::requiredIf(null != $this->option_e['down']), 'nullable', 'string'],
