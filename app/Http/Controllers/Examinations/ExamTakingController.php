...
class ExamTakingController extends Controller
{
    ...
    {
        return view('examinations-hub.take.join');
    }
    ...
    public function authenticate(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('examinations-hub.take.start', $exam);
    }
    ...
    public function start(GeneralExam $exam): View|RedirectResponse
    {
        ...
        if ($submission->submitted_at) {
            return redirect()->route('examinations-hub.take.completed', $exam);
        }
        ...
        return view('examinations-hub.take.start', [
            'exam' => $exam,
    ...
    public function section(GeneralExam $exam, int $sectionIndex): View|RedirectResponse
    {
        ...
        return view('examinations-hub.take.section', [
            'exam' => $exam,
            'submission' => $submission,
            'section' => $section,
