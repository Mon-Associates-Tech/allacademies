...
use App\Examinations\Services\ExamQuestionPreviewService;
use App\Examinations\Services\ExamQuestionPersistenceService;
...
class ExamCreationController extends Controller
{
    ...
    public function preview(Request $request): View
    {
        ...
        return view('examinations-hub.exams.preview', [
            'payload' => $payload,
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('examinations-hub.exams.show', $exam)
