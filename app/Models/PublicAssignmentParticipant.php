...
class PublicAssignmentParticipant extends Model
{
    use HasFactory;
    ...
    {
        return $this->morphMany(PublicAssignmentSubmission::class, 'participant');
    }
    ...
    public function getSubmissionForAssignment(PublicAssignment $assignment): ?PublicAssignmentSubmission
    {
        return $this->submissions()
            ->where('public_assignment_id', $assignment->id)
            ->first();
    }

    public function hasSubmittedAssignment(PublicAssignment $assignment): bool
    {
        return $this->submissions()
            ->where('public_assignment_id', $assignment->id)
