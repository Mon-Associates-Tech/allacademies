...
class FlashMessageHandler extends Component
{
    ...
    public function checkFlashMessages(): void
    {
        ...
        foreach ($flashTypes as $type) {
            ...
            if ($flashMessage && is_string($flashMessage)) {
                $this->addFlashMessage($flashMessage, $type === 'message' ? 'info' : $type);
                session()->forget($type);
            }
        }
    }
    ...
    public function addSuccessMessage($message = '', $autoHide = null): void
    {
        $this->addFlashMessage($message, 'success', $autoHide);
    }

    public function addErrorMessage($message = '', $autoHide = null): void
    {
        $this->addFlashMessage($message, 'error', $autoHide);
    }

    public function addWarningMessage($message = '', $autoHide = null): void
    {
        $this->addFlashMessage($message, 'warning', $autoHide);
    }

    public function addInfoMessage($message = '', $autoHide = null): void
    {
        $this->addFlashMessage($message, 'info', $autoHide);
    }
    ...
    public function getMessageIcon($type): string
    {
        return match ($type) {
    ...
    public function getMessageColors($type): array
    {
        return match ($type) {
            'success' => [
    ...
    {
        return view('livewire.common.flash-message');
    }
}
