...
class JoinPublicAssignment extends Component
{
    ...
    // Verification
    public ?PublicAssignmentParticipant $participant = null;
    ...
    public function startAssignment(): void
    {
        ...
        try {
            ...
            $this->redirect(route('public-assignments.take', $submission));
    ...
    {
        return view('livewire.public.join-public-assignment', [
