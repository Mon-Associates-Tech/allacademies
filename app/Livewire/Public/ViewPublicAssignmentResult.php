...
class ViewPublicAssignmentResult extends Component
{
    public ?PublicAssignmentSubmission $submission = null;

    public ?PublicAssignment $assignment = null;
    ...
    public function boot(ParticipantVerificationService $verificationService): void
    {
    ...
    {
        $this->submission = PublicAssignmentSubmission::find($submissionId);
    ...
    protected function canAccessSubmission(): bool
    {
        ...
        if (Auth::check()) {
            ...
            if ($this->submission->participant_type === PublicAssignmentParticipant::class) {
                $participant = PublicAssignmentParticipant::find($this->submission->participant_id);
