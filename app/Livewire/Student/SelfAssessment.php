...
//            $formatted['max_words'] = $questionModel->max_words;
    ...
    {
        // Store questions data in the assessment
    ...
    public function submitAssessment(): void
    {
        try {
            ...
            // Prepare questions data using the stored questions
            $questionsData = [];
            foreach ($this->questions as $index => $question) {
    ...
    public $currentView = 'selection'; // 'selection', 'self-assessment', 'assignment-practice'

    public function switchToSelfAssessment()
    {
        $this->currentView = 'self-assessment';
    }

    public function switchToAssignmentPractice()
    {
        $this->currentView = 'assignment-practice';
    }
    ...
    {
        return view('livewire.students.self-assessments');
    }
}
